...
Section 4 marks out a narrower class of **sensitive personal data** that the Act
subjects to stricter processing conditions than ordinary personal data:
information as to a data subject's physical or mental health, political opinions,
religious beliefs or other beliefs of a similar nature, and the commission or
alleged commission of any offence. Act A1727 added **biometric data** to this
class with effect from 1 April 2025.
...
Compliance with the seven principles is not the only front-end duty. A data
controller that falls within a **registrable class** must register with the
Commissioner before processing personal data — section 14, read with the Personal
Data Protection (Class of Data Users) Order 2013 (P.U.(A) 336). The Order lists
eleven classes: communications; banking and financial institutions; insurance;
health; tourism and hospitality; transportation; education; direct selling;
services (legal, audit, accountancy, engineering, architecture, retail and
wholesale dealing, and private employment agencies); real estate; and utilities.

Registration carries its own offences, separate from the principle penalty above.
Processing without a certificate of registration at all is an offence under section
16(4), punishable by a fine up to **RM500,000** or three years' imprisonment, or
both. Letting a certificate lapse and continuing to process is a lighter offence
under regulation 5(2) of the Registration of Data Users Regulations 2013 (P.U.(A)
337) — a fine up to **RM250,000** or two years, or both — a penalty the 2024
amendment left unchanged.
...
The same tranche also **rewrote the cross-border transfer rules in section 129**.
The old gazetted "whitelist" of approved destinations was removed; personal data
may now be sent to a place outside Malaysia that affords protection **substantially
similar** to Act 709, or where another statutory condition is met. The
Commissioner's 2025 Cross-Border Personal Data Transfer Guidelines flesh out that
standard. The new **right to data portability** (s.43a) lets a data subject require
that their data be transmitted directly to another data controller, subject to
technical feasibility and the compatibility of the data format.

The operating thresholds behind the new DPO and breach-notification duties sit in
the Commissioner's guidelines rather than the section text. A data protection
officer must be appointed where a controller or processor handles the personal data
of **20,000 or more** data subjects, sensitive personal data (including financial
data) of **10,000 or more**, or carries out regular and systematic monitoring; the
officer must be registered with the Commissioner within **21 days** of appointment.
For a personal data breach, the guidelines put the standing duty on a concrete
clock: the controller must notify the Commissioner **within 72 hours** where the
breach causes or is likely to cause significant harm — physical harm, financial
loss, or a breach involving sensitive personal data — or affects more than **1,000**
data subjects; and where the breach is likely to cause significant harm, it must
also notify the affected data subjects **within 7 days** of notifying the
Commissioner.
...
This page is the statute record. The finer operating detail — the Personal Data
Protection Standard, the registration forms and fees, and the full data breach
notification and DPO guidelines issued by the Commissioner — sits in subsidiary
instruments and guidance rather than the section text, and will be documented in
their own articles as that cluster is built.
