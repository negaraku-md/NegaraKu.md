---
topicId: MY-LAW-0078
title: "Islamic Family Law: Marriage, Divorce and Custody Rights"
seoTitle: "Malaysia Islamic Family Law: Marriage, Divorce, Hadhanah"
slug: "islamic-family-law-malaysia"
category: "law"
subcategory: ["syariah"]
summary: "A descriptive guide to Islamic family law in Malaysia — marriage, polygamy, talaq, fasakh, khuluk, maintenance and hadhanah — as codified in state enactments and Act 303 for the Federal Territories."
...
answer: "Marriage, divorce and child custody for Muslims in Malaysia are governed by Islamic family law enacted by each state and the Federal Territories, and enforced by the Syariah Courts. For the Federal Territories, the reference is the Islamic Family Law (Federal Territories) Act 1984 (Act 303), which sets out the requirements for marriage, and the procedures for talaq, fasakh, khuluk, maintenance claims and the hadhanah (custody) rights of children. Because it is a state matter, the provisions may vary slightly between states."
keyTakeaways:
  - "Islamic family law is a state matter; each state and the Federal Territories has its own enactment or act, and the Syariah Court adjudicates it."
  - "Under Act 303, the minimum age for marriage is 18 (male) and 16 (female), except with the written permission of a Syariah Judge (section 8)."
  - "Polygamy requires the prior written permission of the Court, and the Court must be satisfied that the marriage is just or necessary and does not cause darar syarie (section 23)."
  - "Divorce includes talaq, fasakh, divorce by redemption (khuluk), ta'liq, and li'an — most of which are confirmed or ordered by the Court (sections 47-52)."
  - "The right of hadhanah (custody) ends when a son reaches 7 years and a daughter 9 years, and may be extended by the Court up to 9 and 11 years (section 84)."
appliesTo: "Muslims in Malaysia, couples married under Islamic Law, law students, and anyone wishing to understand the Syariah Court system."

faq:
  - q: "Is Islamic family law the same throughout Malaysia?"
    a: "Not entirely. It is a state matter, so each state enacts its own enactment and the Federal Territories are subject to Act 303. The framework and terminology are similar, but certain details may differ between states."
  - q: "Can a husband divorce his wife outside of court?"
    a: "Talaq should ideally be pronounced before the Court. If pronounced outside of court, it must be reported to the Syariah Court for confirmation; the Government portal states a reporting period of seven days."
  - q: "Who has the strongest right to custody of a child after divorce?"
    a: "Under section 81 of Act 303, the mother is the person most entitled to the hadhanah of a young child. If the mother is disqualified under Islamic Law, the right passes according to the prescribed order of priority, with the welfare of the child as the paramount consideration."
