...
summary: "A guide to SUHAKAM under the Human Rights Commission of Malaysia Act 1999 (Act 597) — its mandate, investigative powers, and why its findings are recommendatory, not binding."
...
appliesTo: "Citizens and residents who wish to understand the role, powers and limits of SUHAKAM, law students, journalists and anyone considering making a human rights complaint."

faq:
  - q: "Are SUHAKAM's findings binding on the government or the courts?"
    a: "No. Act 597 does not give SUHAKAM's findings binding force. Under section 13(2), when an inquiry discloses a human rights violation, SUHAKAM can only refer the matter to the relevant authority with the necessary recommendations. That authority is required to inform SUHAKAM of the action taken (section 13(3)), but is not obliged to comply with the recommendations."
  - q: "Can SUHAKAM investigate a case that is being heard in court?"
    a: "No. Section 12(2) prohibits SUHAKAM from investigating a complaint that is the subject matter of proceedings pending in any court (including on appeal) or that has been finally decided by a court. If a matter being investigated later becomes the subject matter of court proceedings, SUHAKAM must immediately cease its investigation (section 12(3))."
  - q: "Who appoints SUHAKAM members and how long is their term of office?"
    a: "Members are appointed by the Yang di-Pertuan Agong on the recommendation of the Prime Minister; before giving that advice, the Prime Minister must consult the committee referred to in section 11A (section 5(2)). That committee comprises the Chief Secretary to the Government (as Chairman), the Chairman of the Commission, and three other members from civil society (section 11A). The Commission consists of not fewer than seven and not more than twenty members (section 5(1)). Each member holds office for three years and is eligible for reappointment once for a further three years (section 5(4))."
  - q: "What does 'human rights' mean under Act 597?"
    a: "Section 2 defines human rights as the fundamental liberties enshrined in Part II of the Federal Constitution. Section 4(4) adds that regard shall be had to the Universal Declaration of Human Rights 1948 to the extent that it is not inconsistent with the Federal Constitution."
