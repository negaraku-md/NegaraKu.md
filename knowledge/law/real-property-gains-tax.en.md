---
topicId: MY-LAW-0088
title: "Real Property Gains Tax (RPGT / CKHT)"
seoTitle: "Real Property Gains Tax (RPGT/CKHT): Rates & Exemptions"
slug: "real-property-gains-tax"
category: "law"
subcategory: ["cukai"]
summary: "A guide to Real Property Gains Tax (RPGT/CKHT) in Malaysia — the tax on gains from disposing of real property and shares in real property companies, including rates by holding period, exemptions, and filing responsibilities."
...
appliesTo: "Property sellers, buyers (acquirers), property investors, shareholders of real property companies, and tax/legal advisers in Malaysia."

faq:
  - q: "What is the RPGT rate if I sell a house within three years?"
    a: "For an individual Malaysian citizen or permanent resident, a disposal within the first three years from the date of acquisition is charged at 30% on the chargeable gain."
  - q: "Do I have to pay RPGT if I hold the property for more than five years?"
    a: "For individual citizens and permanent residents (Part I of Schedule 5), a disposal after the fifth year is charged at 0%, effective 1 January 2022. Malaysian companies are charged 10%, and non-citizens are also charged 10% from year 6."
  - q: "What is the once-in-a-lifetime exemption?"
    a: "An individual citizen or permanent resident may elect to exempt the gain from the disposal of one residential home, once only in their lifetime. It must be claimed — it is not applied automatically."
  - q: "When must the RPGT form be filed?"
    a: "The disposer must submit the form (CKHT 1A/1B/3) within 60 days of the date of disposal through the e-CKHT portal on MyTax. The acquirer, in turn, submits CKHT 2A within 60 days. From 2025, the balance of tax must be settled within 90 days of the date of disposal under the Self-Assessment System."
  - q: "Are shares in a real property company still subject to RPGT?"
    a: "For individuals, yes — the disposal of shares in a real property company (RPC) remains under RPGT. However, from 1 March 2024, the disposal of such shares by companies, limited liability partnerships, trust bodies and co-operatives shifts to the Capital Gains Tax regime under the Income Tax Act 1967."
...
In short: the disposal of **physical real property** remains under RPGT for everyone, but the disposal of **RPC shares by corporate entities** is now under CGT. The [Capital Gains Tax](capital-gains-tax) article explains this new regime in more detail.
...
- **Determine the correct regime:** if you are disposing of shares rather than physical property, confirm whether RPGT or [Capital Gains Tax](capital-gains-tax) applies based on your status (individual vs corporate entity).
- **Keep up with the forms:** check the current CKHT 1A/1B/2A/3 form requirements and the 60/90-day deadlines directly on the e-CKHT portal of the [Inland Revenue Board](lhdn), as retention rates and procedures can change through the annual Finance Act.
