...
第 4 条另划出一个较窄的类别——**敏感个人资料**——本法令对其处理施加较普通个人资料
更为严格的条件：有关数据主体身体或精神**健康**、**政治观点**、**宗教信仰**或其他
类似性质的信仰，以及**是否犯下或被指犯下任何罪行**的资讯。Act A1727 自 2025 年
4 月 1 日起把**生物识别数据**纳入此类别。
...
遵守七项原则并非唯一的前端义务。属于**须注册类别**的数据控制者，必须在处理个人
资料之前向专员注册——第 14 条，须与《2013 年个人资料保护（数据使用者类别）令》
（P.U.(A) 336）一并理解。该令列出十一个类别：通讯；银行与金融机构；保险；健康；
旅游与酒店业；交通运输；教育；直销；服务业（法律、审计、会计、工程、建筑、零售与
批发买卖，以及私人职业介绍所）；房地产；以及公用事业。

注册另有其自身的罪行，与上述原则刑罚各自独立。完全未持注册证书而处理，属第
16(4) 条下的罪行，可处最高 **RM500,000** 罚款或三年监禁，或两者兼施。任由证书
过期却继续处理，则属《2013 年数据使用者注册规例》（P.U.(A) 337）第 5(2) 条下较
轻的罪行——最高 **RM250,000** 罚款或两年，或两者兼施——此刑罚在 2024 年修订中
维持不变。
...
同一批次也**改写了第 129 条的跨境转移规则**。过去以宪报公布的核准目的地「白名单」
已被取消；个人资料如今可发送至马来西亚境外、提供与 Act 709 **实质相似**保护的
地方，或在符合另一项法定条件时发送。专员的《2025 年跨境个人资料转移指引》对该
标准作了细化。新增的**数据可携权**（s.43a）容许数据主体要求将其数据直接传输至
另一名数据控制者，惟须视技术可行性及数据格式的兼容性而定。

新的 DPO 与外泄通报义务背后的操作门槛，载于专员的指引而非条文文本。当控制者或
处理者处理**20,000 名或以上**数据主体的个人资料、**10,000 名或以上**数据主体的
敏感个人资料（包括财务数据），或进行定期且系统化的监控时，即须委任一名数据保护官；
该官员须在委任后**21 天内**向专员注册。就个人资料外泄而言，指引把这项持续性义务
落到一个具体的时限上：当外泄造成或可能造成重大伤害——身体伤害、经济损失，或涉及
敏感个人资料的外泄——或影响超过 **1,000** 名数据主体时，控制者必须在 **72 小时内**
通报专员；而当外泄可能造成重大伤害时，控制者还必须在通报专员后 **7 天内**通知
受影响的数据主体。
...
本页只是法令记录。更细的操作细节——Personal Data Protection Standard、注册
表格与费用，以及专员所发出的完整外泄通报与 DPO 指引——载于附属文书与指引之中，
而非条文文本，并将在该群组建立时以各自的文章记录。
