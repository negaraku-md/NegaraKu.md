...
category: "energy"
subcategory: ["gas"]
summary: "How Malaysia moves gas across the Peninsula, liquefies it for export at Bintulu, and prices it for industrial buyers under a regulated, third-party-access market."
...
appliesTo: "Industrial gas buyers, energy analysts, students, and anyone tracking Malaysia's gas value chain and market reforms."

faq:
  - q: "Who owns and operates Malaysia's gas pipeline network?"
    a: "The Peninsular Gas Utilisation (PGU) network is owned and operated by PETRONAS Gas Berhad on behalf of PETRONAS. It stretches 2,623 km with a capacity of about 3,500 mmscfd."
  - q: "Where does Malaysia export LNG from?"
    a: "Almost all of Malaysia's LNG is liquefied and shipped from the PETRONAS LNG Complex at Bintulu, Sarawak, which has nine trains and about 29.3 mtpa of capacity (PETRONAS cites approximately 30 mtpa). The first cargo left Bintulu in 1983, bound for Japan."
  - q: "If Malaysia exports so much gas, why does it also import LNG?"
    a: "Most gas and nearly all LNG comes from offshore Sarawak and Sabah, while Peninsular fields are in structural decline. Two regasification terminals, Sungai Udang and Pengerang, import LNG so the Peninsula's pipeline grid stays supplied even as local production falls."
  - q: "How is industrial gas priced in Malaysia?"
    a: "Since 2017, delivered gas is split into a regulated facility tariff, set by the Energy Commission under Incentive Based Regulation, and the gas molecule price, benchmarked to the Malaysia Reference Price. The facility tariff is a small share of the total; most of the bill is the molecule cost, which tracks LNG export values."
  - q: "What is Third Party Access?"
    a: "Third Party Access (TPA) lets qualified shippers, not just PETRONAS, book capacity on regasification terminals, transmission pipelines, and distribution pipelines on the same terms. It began on 16 January 2017 under the Gas Supply (Amendment) Act 2016 and is regulated by the Energy Commission."
...
| Terminal | Location | Commercial start | Regas capacity |
|---|---|---|---|
| RGT Sungai Udang | Offshore Melaka | Q2 2013 | 500 mmscfd |
| RGT Pengerang | Johor | Q4 2017 | 490 mmscfd |
...
| Plant | Trains | Milestone |
|---|---|---|
| Malaysia LNG (MLNG) | Trains 1–3 | First cargo shipped 1983 |
| MLNG Dua | Trains 4–6 | Second plant, from the 1990s |
| MLNG Tiga | Trains 7–8 | Third plant, from the 2000s |
| PETRONAS LNG 9 | Train 9 | Added 3.6 mtpa |
...
| Rank | Country | 2024 LNG exports (billion ft³/d) |
|---|---|---|
