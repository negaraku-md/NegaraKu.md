---
topicId: MY-ENE-0013
title: "Sarawak Energy Berhad (SEB): Sarawak's Power Utility"
seoTitle: "Sarawak Energy Berhad (SEB): The Sarawak Government-Owned Power Utility"
slug: "sarawak-energy-berhad"
category: "energy"
subcategory: ["utiliti"]
summary: "Sarawak Energy Berhad is a vertically integrated electricity utility wholly owned by the Sarawak Government, operating Sarawak's separate power grid that is generated primarily by hydroelectric plants such as Bakun, Murum and Baleh."
...
answer: "Sarawak Energy Berhad (SEB) is a vertically integrated electricity utility wholly owned by the Sarawak Government. SEB generates, transmits and distributes electricity throughout Sarawak via a state grid that is separate from the Peninsula (TNB), with an available capacity of about 5,898MW dominated by hydroelectricity. Its wholly owned subsidiary, Syarikat SESCO Berhad, acts as the single buyer and owns all of the state's transmission and distribution infrastructure."
keyTakeaways:
...
appliesTo: "Students, researchers, investors and anyone who wants to understand Sarawak's energy sector and its power utility."

faq:
  - q: "Who owns Sarawak Energy Berhad?"
    a: "SEB is wholly owned by the Sarawak Government, with active oversight by state-appointed directors."
  - q: "Is the Sarawak grid the same as TNB's grid in the Peninsula?"
    a: "No. Sarawak has its own grid operated by SEB. Through SESCO, SEB owns all of the state's transmission and distribution infrastructure and acts as the single buyer."
  - q: "What is Sarawak Energy's largest power plant?"
    a: "The Bakun Hydroelectric Plant, with an available capacity of 2,520MW, is the largest generation facility in Sarawak."
...
verificationNeeded:
  ...
  - "Press Metal's contribution of approximately 40% is specific to the first half of 2025 (1H 2025) according to RAM; confirm the figure for the latest period."
  - "The Baleh commissioning date (fourth quarter 2030) is subject to construction progress; confirm with the latest SEB updates."
  - "Capacity and financial figures change over time; confirm with SEB's latest annual report and media releases."
revisions:
  - revision: 0
    date: 2026-08-01
...
While Peninsular Malaysia relies on Tenaga Nasional Berhad, Sarawak lights its own lamps through a single utility whose grid is not connected at all to the national grid — and which is generated almost entirely by the waterfalls of giant dams in the interior.
...
- Read the **[Tenaga Nasional Berhad](/en/energy/tenaga-nasional-berhad)** profile to compare the Peninsula and Sarawak utility models.
- For the engineering details of Sarawak's largest dam, explore the official **[Bakun Hydroelectric Plant](https://www.sarawakenergy.com/bakun-hydroelectric-plant)** page.
