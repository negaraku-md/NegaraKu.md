...
category: "finance"
subcategory: ["lending"]
summary: "How Malaysian banks price and approve retail loans — the Standardised Base Rate that ties your instalment to the OPR, the debt service ratio that decides how much you can borrow, and the Hire Purchase Act that governs car financing."
...
appliesTo: "Malaysian consumers taking a home, personal or car loan, and anyone comparing bank financing offers."

faq:
  - q: "Why did my home loan instalment go up even though my bank did not change its rate?"
    a: "Floating-rate loans are priced as SBR plus a fixed spread. The SBR moves automatically whenever BNM changes the OPR — the same amount, up or down — so a rise in the OPR raises your rate without any independent decision by the bank."
  - q: "Does Bank Negara Malaysia set a maximum debt service ratio?"
    a: "No. BNM requires banks to verify income and assess affordability under its responsible financing rules, but it does not fix a single DSR cap. Each bank sets its own internal ceiling — and does not publish it — which is why two banks can give different answers on the same payslip."
  - q: "What is the difference between BLR, BR and SBR?"
    a: "The Base Lending Rate (BLR) was the old reference rate. From 2 January 2015 it was replaced by the Base Rate (BR) for new loans, and from 1 August 2022 the Standardised Base Rate (SBR) — tied solely to the OPR — became the common reference for new retail floating-rate loans. The BLR still exists only for legacy loans."
  - q: "Can the bank repossess my car after one missed payment?"
    a: "Under the Hire Purchase Act 1967 a financier can generally only repossess after the hirer has defaulted on two successive instalments and follows a 21-day notice process. Once you have paid at least 75% of the cash price, the financier needs a court order to repossess."
