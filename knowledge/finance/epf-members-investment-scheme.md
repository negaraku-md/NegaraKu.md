...
summary: "Eligible EPF members can move a slice of their retirement savings into approved unit trust funds through the Members Investment Scheme, run online via the i-Invest tool in i-Akaun."
...
answer: "The EPF Members Investment Scheme (marketed as i-Invest inside i-Akaun) lets eligible members transfer up to 30% of the savings they hold above the age-based Basic Savings threshold in their Akaun Persaraan into unit trust funds approved by the EPF. The minimum per transaction is RM1,000, the eligible amount is valid for three months at a time, and buying online through i-Invest caps the sales charge at 0.5%."
keyTakeaways:
...
appliesTo: "EPF members aged 18 to below 55 who have savings above the Basic Savings threshold and want to self-direct part of it into unit trusts."

faq:
  - q: "Who is eligible to invest under the Members Investment Scheme?"
    a: "EPF members from age 18 up to below 55 whose Akaun Persaraan savings exceed the Basic Savings amount set for their age. Members aged 55 and above invest instead through the Age 55/60 Withdrawal (Investment) option."
  - q: "How much of my EPF savings can I invest?"
    a: "Up to 30% of the amount in your Akaun Persaraan that exceeds your Basic Savings threshold. The calculation is (Akaun Persaraan balance minus Basic Savings) multiplied by 30%."
  - q: "What is the minimum I can invest and how often?"
    a: "The minimum is RM1,000 per transaction. Your eligible amount is valid for three months at a time, so in practice you can make a fresh transfer once that period lapses."
