---
topicId: MY-FDL-0002
title: "Cinema, Entertainment and Censorship Rules in Malaysia"
seoTitle: "Malaysia Film Classification, Censorship & Entertainment Licences"
slug: "cinema-entertainment-and-censorship"
category: "food-lifestyle"
subcategory: ["hiburan"]
summary: "Every film screened for public viewing in Malaysia must first be approved by the Film Censorship Board (LPF) and given an age classification — U, P12, 13, 16 or 18 — while karaoke centres and entertainment premises are instead licensed by local authorities under their respective by-laws."
...
appliesTo: "Viewers, cinema operators, film producers, karaoke centre and entertainment premises operators, and anyone wishing to understand how entertainment censorship and licensing works in Malaysia."

faq:
  - q: "What does the P12 classification on a film poster mean?"
    a: "P12 means the film is suitable for all ages, but viewers under 12 require parental or guardian guidance while watching. It was introduced under the Film Classification 2023 system that took effect on 2 February 2023."
  - q: "Do films on Netflix or YouTube need to be censored by the LPF?"
    a: "No. The LPF's pre-screening approval process applies to films screened for public viewing such as in cinemas, and is not required for films distributed via the internet. Online content is subject to other forms of regulation."
  - q: "Who issues the licence for a karaoke centre?"
    a: "The local authority (PBT) in the area where the premises are located, not the LPF. For example, in Kuala Lumpur, family karaoke centre licences are issued by Kuala Lumpur City Hall (DBKL) with specific conditions such as operating hours and visitor age limits."
  - q: "What is the penalty for screening a film without LPF approval?"
    a: "Possessing, distributing or screening a film without a licence or approval is an offence under the Film Censorship Act 2002, with a fine of between RM5,000 and RM30,000 and/or imprisonment for a maximum term of 3 years."
...
verificationNeeded:
  ...
  - "The conditions and fees for a DBKL family karaoke licence and the MACP licence fees (public performance RM1,200–RM27,000; recorded music in restaurants RM847–RM1,376) are drawn from a secondary business-guide source (MISHU); confirm with DBKL/PBT and MACP Berhad."
  - "The 'food-lifestyle' category placement and 'none' sensitivity for a national-censorship topic — a human may reassess whether this classification is appropriate for a legal/censorship topic."
sources:
...
| --- | --- |
| **U** | All age groups |
| **P12** | All ages, but viewers under 12 require parental/guardian guidance |
| **13** | Viewers aged 13 and above |
| **16** | Viewers aged 16 and above |
| **18** | Viewers aged 18 and above |
...
| Item | DBKL condition (family karaoke) |
| --- | --- |
| Location | Must not be near residential areas, schools, hospitals, universities or places of worship |
| Operating hours | 10:00 am to 12:00 midnight |
| Age limit | Visitors aged 21 and above; those under 21 must be accompanied by a guardian |
| Prohibition | No children in school uniform are allowed to enter |
| Fee | RM10 per month for each *jukebox* machine |
| Deposit | RM200 (one-off, for each *jukebox*) |
...
- To understand other limits on public content, read the [Sedition Act](/law/sedition-act) — a separate law that also touches on what may be disseminated to the public.
- See the [Consumer Protection Act](/law/consumer-protection-act) for background on how advertising and services are regulated in Malaysia.
