...
socialTitle: "Your shareholders agreement cannot contract out of s.346. Nothing can."
slug: "shareholders-agreement-malaysia"
category: "business"
subcategory: ["contracts-disputes"]
summary: "Where a Malaysian shareholders agreement stops and the Companies Act 2016 takes over — the clauses that must sit in the constitution instead, and the oppression remedy under s.346 that no agreement can exclude."
...
appliesTo: "Founders, minority investors and family shareholders in a Sdn Bhd negotiating or reviewing a shareholders agreement, joint venture agreement or investment agreement."

faq:
  - q: "Do I need a shareholders agreement if the company already has a constitution?"
    a: "They do different jobs. The constitution is a public document lodged with SSM that binds the company and all members. A shareholders agreement is private and binds only signatories, which is where confidential commercial terms, funding obligations, exit mechanics and personal covenants belong. Most well-run companies with more than one owner have both, drafted together."
  - q: "Which one wins if the shareholders agreement and the constitution conflict?"
    a: "Against the company, the constitution. The company is not a party to the agreement unless it signs, and even then a company cannot be bound to exercise a statutory power in a particular way. Between the individual signatories, the agreement can still work as a personal contract, sounding in damages. Good drafting includes a clause requiring the parties to vote to amend the constitution so the conflict never arises."
  - q: "Can a shareholders agreement stop a shareholder from petitioning for oppression?"
    a: "No. Section 346 confers a right on any member or debenture holder to apply to the Court. It is a statutory remedy against the manner in which the company's affairs are conducted, and the Court's powers under s.346(2) include regulating the company's future conduct and ordering a buyout. A private agreement cannot remove a jurisdiction Parliament conferred."
  - q: "Can we agree that a founder can never be removed as director?"
  ...
  - q: "Does a shareholders agreement bind someone who later buys shares?"
    a: "Not by itself. That is why a deed of adherence is standard, and why the transfer restriction that makes adherence a condition of registration has to live in the constitution — the constitution is what the board applies when it decides whether to enter a transferee in the register under s.106."
  - q: "Do we need to lodge the shareholders agreement with SSM?"
    a: "No. Unlike the constitution, which is lodged under s.32(4) and available on the public record, a shareholders agreement stays private. That privacy is one of its main advantages and one of its main weaknesses."
...
Two founders sign a twenty-page shareholders agreement. It gives each of them a board
