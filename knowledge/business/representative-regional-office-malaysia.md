...
summary: "A Representative Office (RE) or Regional Office (RO) lets a foreign company set up a non-trading presence in Malaysia to scout the market, run R&D, or coordinate regional affiliates. MIDA approves this status without requiring incorporation, subject to a minimum operating budget and strict limits on commercial activity."
