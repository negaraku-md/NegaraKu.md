...
keyTakeaways:
  - "금융서비스법(FSA 2013) 부속서 1 제1부 제1편은 승인이 필요한 업무를 열거합니다: 지급 시스템 운영과 지정 지급수단 발행"
  - "승인 없이 승인 대상 업무를 영위하면 s.8(3)에 따라 최대 10년의 징역 또는 RM50,000,000의 벌금에 처해집니다"
  - "가맹점 매입 서비스(merchant acquiring)는 부속서 1 제2부에 s.17에 따른 등록 대상 업무로 포함되며, s.17(3)에 따라 최대 8년 또는 RM25,000,000에 처해집니다"
  - "지정 지급수단은 차지카드, 신용카드, 직불카드 및 전자화폐이며, P.U.(A) 82/2016으로 개정된 P.U.(A) 202/2013으로 규정됩니다"
  - "승인된 표준 전자화폐 발행자는 RM1,000,000 또는 미상환 전자화폐 부채의 8% 중 더 큰 금액에 해당하는 최소 자본금을 갖추어야 합니다"
  - "2025년 1월 2일부터 시행된 P.U.(A) 463/2024은 제한적 용도 전자화폐 네 가지 범주를 승인 요건에서 전면 면제합니다"
  - "범주 1 폐쇄형(closed-loop) 면제는 사용자당 충전 한도를 RM500으로, 발행자당 미상환 부채와 월평균 거래액을 각각 RM1,000,000으로 제한합니다"
appliesTo: "전자지갑, 선불형 상품, 적립·보상 제도, 자금을 보유하는 마켓플레이스를 구축하는 창업자, 그리고 지급 라이선스가 필요하다고 들은 모든 분."

verificationNeeded:
  - "특정 마켓플레이스 또는 에스크로 방식 흐름이 부속서 1에 따른 지급 시스템 운영에 해당하는지는 사실관계에 달려 있습니다; 말레이시아 중앙은행(BNM)은 일반적인 적용 범위 지침을 공표하지 않으므로 그 입장은 중앙은행에 확인해야 함"
  - "송금 및 국경 간 자금 이체는 여기서 다루지 않는 별도의 라이선스 체계인 자금서비스업법(Money Services Business Act 2011)에 속합니다"
  - "말레이시아 중앙은행(BNM)의 지급 시스템 관보 명령 페이지는 등록 대상 업무 요건을 개정하는 P.U.(A) 468/2024을 열거하지 않습니다 — 해당 목록을 불완전한 것으로 간주하고 법무장관실(AGC) 관보 포털을 확인하십시오"
