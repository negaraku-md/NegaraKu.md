---
topicId: MY-BIZ-0126
title: "Starting an E-commerce or Online Business in Malaysia"
...
E-commerce feels informal — you can be selling on a marketplace by dinnertime — which fools a lot of people into thinking the rules do not apply. They do. Malaysia treats an online seller like any other business: you must register, disclose who you are, protect customer data, and pay the right tax. The rules also changed recently, so even sellers who set up a few years ago may be running on stale information.

This playbook walks the real steps to start an online business in Malaysia, and flags the two areas — e-commerce disclosure and e-invoicing — where the law moved most recently.

## Step 1: Register with SSM — yes, even online

There is a persistent myth that a home-based or marketplace-only seller does not need to register. Not true. Any activity carried on for profit must be registered with **SSM within 30 days** of starting, and trading unregistered is an offence. Two routes:

- a **sole proprietorship or partnership** under the Registration of Businesses Act 1956, via the **ezBIZ** portal — quick and cheap, open to citizens and PRs; or
- a **Sdn Bhd** under the Companies Act 2016, via MyCoID — a separate legal entity, and the required route for foreign owners.

One warning: use the **official site, ssm.com.my** (portal ezbiz.ssm.com.my). A number of lookalike "SSM" domains are third-party resellers, not the Commission. For the entity choice, see the guide on sole proprietorship versus Sdn Bhd.

Note what this step is *not*: there is **no separate "online business licence"** in Malaysia. SSM registration is the baseline, and your other obligations flow from consumer, data and tax law — not from a special e-commerce permit. (Your local council may issue a home-business or signboard permit; check your Majlis.)
...
Three tax points matter for an online business:
