...
faq:
  - q: "How much does it cost to register a sole proprietorship in Malaysia?"
    a: "SSM charges RM30 a year for a business registered under your personal name (as it appears on your MyKad) and RM60 a year for one registered under a trade name, with an extra RM5 for each branch and RM10 for a printed business information extract. There is no incorporation fee and no company-secretary cost, which makes it the cheapest legal way to start."
