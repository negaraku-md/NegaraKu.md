...
category: "business"
subcategory: ["closing"]
summary: "A routing page for the five exits available to a Sdn Bhd — striking off, members' voluntary winding up, creditors' voluntary winding up, corporate rescue and a sale — and how to tell which one your situation actually allows."

tier: "3"
mode: "practical"
contentType: "guide"

answer: "There are five exits from a Sdn Bhd, and solvency plus what the company still owns decide which one is open. A dormant company with no assets and no liabilities can be struck off for RM100. A solvent company with assets needs a members' voluntary winding up. An insolvent one needs a creditors' voluntary winding up, unless the business is still viable, in which case corporate rescue applies. A profitable business is usually sold rather than closed."
keyTakeaways:
...
Stopping trading is not closing a company. A quiet Sdn Bhd still exists, still
