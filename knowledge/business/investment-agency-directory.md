...
summary: "A directory of the agencies a foreign investor must deal with — MIDA, MITI, MDEC, KPDN, SSM, ESD, MyIPO and the regional corridor authorities — with what each one actually issues and the order to approach them in."

tier: "4"
mode: "practical"
contentType: "agency"

answer: "SSM incorporates the company and does nothing else. MITI issues the manufacturing licence through MIDA, MDEC awards Malaysia Digital status, KPDN regulates foreign participation in distributive trade, and the Immigration Department's Expatriate Services Division registers the company before any work pass. Sector regulators such as BNM, the Securities Commission, MCMC and PETRONAS impose their own equity and capital conditions. Approach them in sequence: SSM, then the sector regulator, then ESD."
keyTakeaways:
...
Foreign investors arrive expecting one regulator. Malaysia has a dozen, they do not
...
| **KPDN** — [Ministry of Domestic Trade and Cost of Living](/government/ministry-of-domestic-trade-kpdn) | Ministry | Foreign participation in **distributive trade**, under the Garis Panduan Penyertaan Asing dalam Sektor Perdagangan Pengedaran di Malaysia; direct selling and franchise regulation |
