...
appliesTo: "Readers who want to understand, in descriptive terms, how a Malaysian state government is organised — students, civil servants, journalists, and anyone trying to work out why some states have a Menteri Besar and an Istana Negeri while others have a Chief Minister and a governor."
...
| --- | --- |
| Yang di-Pertuan Agong | Ruler (9 states) or Yang di-Pertua Negeri (Penang, Malacca, Sabah, Sarawak) |
| Prime Minister | Menteri Besar (9 Ruler states) or Chief Minister (Penang, Malacca, Sabah, Sarawak) |
| Cabinet | State Executive Council (EXCO), also called Majlis Mesyuarat Kerajaan Negeri |
...
The number of elected seats itself is not fixed by the Federal Constitution at all; each state's own law sets its own number, which is why assemblies of very different sizes exist across the 13 states. For the full clause-by-clause detail of how a DUN is formed, how long it can be kept from a floor vote, and how a Bill's passage actually works, see [State Legislative Assemblies (DUN)](/en/government/state-assemblies-dun) — this article deliberately stays at the level of overall structure rather than repeating that detail.
...
Federal law still overrides state law where the two conflict, and the Concurrent List (social welfare, town and country planning, public health, and others) is shared ground. For the fuller picture of how these lists interact across all three tiers of government, see [Malaysia's three tiers of government](/en/government/three-tiers-of-government) and [who makes law on what](/en/government/federal-state-division).

## Sabah and Sarawak: an extended list

Sabah and Sarawak legislate over an additional supplement to the State List and Concurrent List — covering matters such as native law and custom, native courts, ports and harbours not declared federal, and water supplies — set out separately under Article 95B of the Federal Constitution. This reflects the terms on which the two states joined the Federation in 1963, alongside other safeguards specific to them. See [Constitutional safeguards for Sabah and Sarawak](/en/states/sabah-sarawak-safeguards) for the full picture.
...
- [Rulers and governors](/en/states/rulers-and-governors) — how the two kinds of state head of state differ in title, tenure and religious role.
- [State Legislative Assemblies (DUN)](/en/government/state-assemblies-dun) — the Eighth Schedule's clause-by-clause rules for how a state assembly is formed, runs, and passes law.
- [Prime Minister and Cabinet](/en/government/kabinet-perdana-menteri) — the federal-level version of the same confidence test and collective-responsibility rule.
- [Malaysia's three tiers of government](/en/government/three-tiers-of-government) — where state government sits between the federal government and local authorities.
- [Who makes law on what: Federal, State and Concurrent Lists](/en/government/federal-state-division) — the full division of legislative power behind the State List.
- [Constitutional safeguards for Sabah and Sarawak](/en/states/sabah-sarawak-safeguards) — the extra powers and protections specific to the two Borneo states.
