---
topicId: MY-STA-0025
title: "How State Governments Are Funded in Malaysia"
seoTitle: "How State Governments Are Funded: Revenue, Grants & the Constitution"
slug: "how-state-governments-are-funded"
category: "states"
subcategory: ["fiskal"]
summary: "The Federal Constitution limits state revenue to land, mines, forests and certain licences, while the major taxes are collected by the Federation; the gap is filled in part by constitutional grants such as the capitation grant and the state road grant."
...
answer: "State governments in Malaysia are funded from the revenue sources assigned to them under the Federal Constitution (chiefly land, mines, forests, certain licences, and zakat), plus statutory grants from the Federation such as the capitation grant and the state road grant under Article 109. Because high-impact taxes such as income tax and the sales and services tax are collected by the Federation, most states depend on land-based revenue and federal transfers. Sabah and Sarawak have additional sources and special grants under Article 112C and the Tenth Schedule."
keyTakeaways:
  - "Article 110 and Part III of the Tenth Schedule set out the sources of state revenue: among them, revenue from land, mines and forests, certain licences, entertainment duty, as well as zakat, fitrah and baitulmal."
  - "Article 109 requires the Federation to pay a capitation grant (based on population) and a state road grant to each state."
  - "The capitation grant rates in the Tenth Schedule start at RM72.00 per person for the first 100,000 population, then fall to RM10.20, RM10.80 and RM11.40 per person for the succeeding population bands."
  - "Sabah and Sarawak receive special grants under Article 112C and additional sources (Tenth Schedule Part V) including state sales taxes, timber export duty, and mineral royalties."
  - "One independent analysis (ISEAS) estimated state revenue at around RM926 per capita in 2023, which is about 10.3% of federal revenue of RM8,969 per capita according to that study's table."
appliesTo: "Citizens, students, policy researchers and anyone wanting to understand federal-state financial relations in Malaysia."

faq:
  - q: "Can state governments levy their own income tax or SST?"
    a: "No. Federal income tax and the sales and services tax are collected by the Federal government. Under the Tenth Schedule, only Sabah and Sarawak are given additional sources including 'state sales taxes'."
  - q: "What is the capitation grant?"
    a: "It is a statutory grant paid by the Federation to each state based on population, under Article 109(1)(a) and Part I of the Tenth Schedule."
  - q: "Why are Sabah and Sarawak different?"
    a: "Both states receive special grants under Article 112C and additional revenue sources under Part V of the Tenth Schedule, including duties on petroleum products, export duties on timber and forest produce, mineral royalties, and state sales taxes."
...
revision: 0
verificationNeeded:
  - "The accuracy of each ISEAS figure (RM926 state revenue per capita; RM8,969 federal revenue per capita; RM4,414 revenue per capita for Sarawak; Selangor's land share 82%; Pahang/Kelantan forestry revenue 18–20%; Selangor per-capita grant RM77.2 million) and the exact reference year for each, against the study's original tables."
  - "An internal inconsistency in the ISEAS study: the narrative text says federal revenue of RM28,153 per capita, but Table 1 of the same study shows RM8,969 per capita. Only the RM8,969 figure is consistent with the stated ratio of 10.3% and with actual federal revenue estimates. Confirm the official federal revenue per capita figure from the Ministry of Finance / Economic Report."
