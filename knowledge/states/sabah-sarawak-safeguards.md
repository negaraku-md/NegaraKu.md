...
summary: "When Sabah and Sarawak joined the Federation in 1963 they kept a set of safeguards written into the Federal Constitution: control over immigration into the two states (including of Malaysians from the Peninsula), two extra legislative lists that give them powers the Peninsular states do not have, native courts and the special position of natives, special financial grants and revenue sources, and a rule that a defined group of these provisions cannot be amended without the consent of the state's Governor. This article sets out each safeguard descriptively — what the Constitution provides and where — without adjudicating any dispute over how they are honoured."

tier: "S"
mode: "practical"
contentType: "law"

answer: "Sabah and Sarawak entered the Federation of Malaysia in 1963 with safeguards entrenched in the Federal Constitution. The most visible is immigration autonomy: Article 9(3) lets Parliament restrict movement into a state with a 'special position', and Part VII of the Immigration Act 1959/63 places entry into and residence in Sabah and Sarawak — including by Malaysian citizens from Peninsular Malaysia — under the control of each state's immigration authority. Beyond that, Article 95B gives the two states supplementary legislative lists (List IIA and List IIIA of the Ninth Schedule) covering matters such as native law and custom, ports and harbours, and (for Sabah) the Sabah railway; Article 161A protects the special position of natives and reserves land for them; Article 161B restricts practising in the states' courts to residents; Articles 112C and 112D provide special grants and assigned revenue, reviewed periodically; and Article 161E entrenches a defined list of these provisions so they cannot be amended without the concurrence of the Yang di-Pertua Negeri (Governor) of the state affected."
keyTakeaways:
  - "Immigration into Sabah and Sarawak is controlled by each state under Part VII of the Immigration Act 1959/63, and Article 9(3) permits Parliament to restrict movement into a state with a special position — which is why a Malaysian from the Peninsula can be refused entry or given a limited pass at a Sabah or Sarawak checkpoint"
  - "Article 95B adds two extra legislative lists for the two states — List IIA (Supplement to State List) and List IIIA (Supplement to Concurrent List) in the Ninth Schedule — covering matters such as native law and custom, ports and harbours, land survey, and the Sabah railway, that Peninsular states do not legislate on"
  - "Article 161A protects the special position of the natives of Sabah and Sarawak, defines who is a 'native' separately for each state, and preserves the reservation of land for natives"
  - "Native courts, and the right of audience in them, are a matter for each state under List IIA; Article 161B restricts appearing before the courts in Sabah and Sarawak to persons resident there"
  - "Articles 112C and 112D provide special grants and assigned revenue sources set out in Parts IV and V of the Tenth Schedule, subject to periodic review by the Federal and State Governments"
  - "Article 161E entrenches a defined set of these safeguards: they cannot be amended without the concurrence of the Yang di-Pertua Negeri (Governor) of Sabah or Sarawak, on top of the ordinary two-thirds majority needed for constitutional amendment"
appliesTo: "Anyone — traveller, employer, student, or reader of Malaysian federalism — who wants a plain, descriptive account of the constitutional safeguards Sabah and Sarawak hold, and where each one is written, without taking a side in the debate over how they are implemented."
...
Fly from Kuala Lumpur to Kota Kinabalu or Kuching and you land in Malaysia — same country, same passport, same currency — and then queue at an immigration counter. A Peninsular Malaysian who cannot state a good reason to be there can be given a pass limited to a few weeks, or turned back. That checkpoint is not a bureaucratic quirk. It is one of a set of safeguards written into the Federal Constitution when Sabah and Sarawak joined the Federation in 1963.
