...
subcategory: ["ewallet"]
summary: "Touch 'n Go eWallet, Boost, GrabPay dan ShopeePay dikawal selia oleh Bank Negara Malaysia sebagai pengeluar e-wang, bukan bank. Baki e-wallet anda bukan deposit dan tidak dilindungi PIDM secara langsung — ia dilindungi melalui akaun amanah yang dipegang di bank."
...
appliesTo: "Pengguna e-wallet di Malaysia yang ingin memahami perlindungan wang mereka, dan sesiapa yang membandingkan baki e-wallet dengan akaun bank."

faq:
  - q: "Adakah baki dalam Touch 'n Go eWallet atau Boost saya dilindungi PIDM seperti simpanan bank?"
    a: "Tidak secara langsung. PIDM melindungi deposit di bank ahli sehingga RM250,000 seorang pendeposit setiap bank ahli. Baki e-wallet bukan deposit. Ia dilindungi secara tidak langsung apabila dana pengguna dipegang dalam akaun amanah di bank ahli PIDM, dan hanya jika penerima manfaat didedahkan dalam rekod bank — perlindungan itu terpakai kepada akaun amanah, bukan aplikasi e-wallet."
  - q: "Adakah e-wallet membayar faedah atas baki saya?"
    a: "Tidak. Perenggan 26.1 dokumen dasar BNM melarang pengeluar e-wang membayar faedah, keuntungan atau apa-apa bentuk pulangan yang menambah nilai monetari baki e-wang anda."
  - q: "Apa jadi kepada wang saya jika syarikat e-wallet gulung tikar?"
    a: "Kerana dana pengguna dipisahkan dalam akaun amanah dan bukan sebahagian modal kerja syarikat, ia terlindung daripada pemiutang syarikat. Pengeluar wajib memulangkan dana pelanggan dan menyerahkan rekod yang mengenal pasti penerima manfaat kepada pemegang amanah untuk agihan semasa penggulungan."
  - q: "Berapa banyak boleh saya simpan dalam e-wallet?"
    a: "Setiap pengeluar menetapkan had dompet sendiri. BNM memerlukan kelulusan bertulis jika had dompet dinaikkan kepada RM5,000 atau lebih, atau jika terdapat perubahan fungsi produk."
  - q: "Adakah GrabPay dan ShopeePay juga dikawal selia?"
    a: "Ya. Keempat-empat — TNG Digital Sdn Bhd, Axiata Digital E-code Sdn Bhd (Boost), GPay Network (M) Sdn Bhd (GrabPay) dan ShopeePay Malaysia Sdn Bhd — tersenarai sebagai pengeluar e-wang bukan bank dalam senarai rasmi BNM."
...
1. Pengeluar mesti memulangkan dana yang dikutip daripada pelanggan dan menyelesaikan amaun tertunggak dengan peniaga pada masa yang munasabah.
2. Ia mesti menghubungi dan memberi peringatan berkala kepada pelanggan untuk menuntut baki yang belum dituntut.
3. Ia mesti mengekalkan rekod yang mengenal pasti penerima manfaat dana e-wang, dan menyediakan rekod itu kepada **pemegang amanah** yang menguruskan akaun amanah untuk memudahkan agihan yang betul.
