---
topicId: MY-LIV-0128
title: "Zakat as a Tax Rebate: How It Works for Muslim Taxpayers"
seoTitle: "Zakat Tax Rebate LHDN: Section 6A Income Tax Act 1967"
slug: "zakat-tax-rebate"
category: "money-daily-life"
subcategory: ["zakat"]
summary: "Zakat paid to a recognised state zakat body reduces income tax ringgit-for-ringgit under Section 6A(3) of the Income Tax Act 1967 — a rebate, not a relief. This article explains the mechanism, the requirements for the authorised body, and receipt-keeping for an LHDN audit, factually."
...
appliesTo: "Individual Muslim taxpayers in Malaysia who pay zakat and file income tax; Muslim business owners who want to understand the difference in treatment between individuals and companies."

faq:
  - q: "Is zakat a tax relief or a tax rebate?"
    a: "Zakat is a tax rebate under Section 6A(3) of the Income Tax Act 1967, not a relief. A rebate reduces the amount of tax payable directly, whereas a relief only reduces taxable income before the tax rate is applied."
  - q: "Can zakat produce a tax refund if it exceeds my tax?"
    a: "No. Section 6A(4) states that if the total rebate exceeds the tax charged, the excess is not paid to the individual and cannot be carried as a credit to reduce that year's or subsequent years' tax. The lowest tax becomes RM0."
  - q: "Does zakat paid directly to asnaf qualify for the rebate?"
    a: "To qualify, the payment must be evidenced by a receipt issued by a religious authority established under written law. Payments without an official receipt from such a body do not meet the requirement of Section 6A(3)."
  - q: "How is business zakat treated differently for companies?"
