---
topicId: MY-CS-0048
title: "Changing a Company's Financial Year End"
seoTitle: "Changing a Company's Financial Year End (FYE) in Malaysia"
slug: "change-of-financial-year-end"
category: "company-secretary"
subcategory: ["pelaporan"]
summary: "The Companies Act 2016 does not provide any specific form or notice to SSM for changing a company's financial year — the change is decided by the directors, but the deadlines for circulating and lodging the financial statements still apply."
...
appliesTo: "Directors, company secretaries and finance officers of Sdn Bhd companies who wish to change the financial year end (FYE)."

faq:
  - q: "Do I need to file a form with SSM to change the financial year?"
    a: "No. The Companies Act 2016 does not provide any specific form or notice to SSM for the FYE change itself; the change is decided by the board of directors and takes effect through the next set of financial statements. SSM becomes aware of the new financial year through the financial statements lodged under s.259, which reflect that FYE."
  - q: "When must the change be notified to LHDN?"
    a: "Via Form CP204B on MyTax, before the end of the relevant accounting period. The exact deadline differs depending on whether the new period is shortened or extended, and should be confirmed with LHDN or the current Public Ruling before filing."
  - q: "Do the financial statement filing deadlines change?"
    a: "Yes. The 6-month period for circulation (private companies, s.258) and the 30-day period for lodgement with SSM (s.259) are recalculated from the new financial year end."
