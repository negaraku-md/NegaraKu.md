---
topicId: MY-CS-0059
title: "Striking a Company's Name Off the SSM Register"
seoTitle: "How to Apply to Strike Off a Company (Section 550)"
slug: "strike-off-company"
category: "company-secretary"
subcategory: ["strike-off"]
summary: "A guide to the conditions and procedure for a director or member to apply to SSM to strike a dormant company's name off the register under section 550 of the Companies Act 2016 — including the liabilities that disqualify an application, the fees, and the objection period."
...
answer: "A director or member of a company may apply to SSM to strike the company's name off the register under section 550 of the Companies Act 2016 if the company is no longer carrying on business or is not in operation, has no assets and liabilities, has no outstanding tax or penalties, and is not involved in any legal proceedings. The application is filed through the Corporate Registry System (CRS) with a fee of RM100, together with the members' resolution and management accounts. Once notice is gazetted under subsection 551(3), the company is dissolved; any party may object within 60 days in accordance with the SSM Guidelines (Revised 14 July 2026)."
keyTakeaways:
  - "Striking off is only for dormant companies with no assets and liabilities — it is not a substitute for a voluntary winding up if the company still holds capital."
  - "Eleven conditions must be met under paragraph 6 of the SSM Guidelines (Revised 14 July 2026), including a members' resolution under section 290, no outstanding charges, no declared dividends, and tax clearance from LHDN."
  - "The application fee is RM100 (Item 27); an objection is RM300 (Item 28); a withdrawal is RM500 (Item 29) — Schedule of Fees, Companies Regulations 2017."
  - "Under the SSM Guidelines (Revised 14 July 2026), any person may object within 60 days from the date of the notice under subsection 551(1); SSM may suspend the process for one year."
  - "After dissolution, the liabilities of directors and members remain enforceable, and the name may be restored by the court within seven years."
appliesTo: "Directors, shareholders, and company secretaries managing a dormant Sdn Bhd or Berhad company in Malaysia who wish to formally end its existence."

faq:
  - q: "What is the difference between striking off a company's name and a voluntary winding up?"
    a: "Striking off under section 550 is a cheaper and faster administrative process for a dormant company that has no assets and liabilities. A voluntary winding up is required when the company still holds capital or has assets/liabilities to settle — the SSM Guidelines prohibit striking off if the company still holds its capital."
  - q: "How long does the strike-off process take?"
    a: "There is no fixed statutory period. Once SSM is satisfied and issues the notice, any party is given 60 days to object in accordance with the SSM Guidelines (Revised 14 July 2026). If there is a valid objection, SSM may suspend the process for one year. The company is only dissolved when the notice is gazetted under subsection 551(3)."
  - q: "Can a company's name be restored after it is struck off?"
    a: "Yes. Any aggrieved person may apply to the Court within seven years from the date of dissolution to restore the company's name to the register under subsection 555(1) of the Companies Act 2016."
  - q: "Are directors' liabilities extinguished after the company is dissolved?"
    a: "No. Under section 554(1)(a), the liability of every director, officer, or member of the company continues and may be enforced as if the company had not been dissolved. Directors must also keep the company's records for seven years after the strike-off."
