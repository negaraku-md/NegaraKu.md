---
topicId: MY-CS-0053
title: "How a Company Executes Documents (Common Seal and Its Alternatives)"
seoTitle: "Execution of Documents by a Company: Common Seal & Signatures (Section 66)"
slug: "execution-of-documents-by-company"
category: "company-secretary"
subcategory: ["penyempurnaan"]
summary: "Since the Companies Act 2016, the common seal is no longer mandatory. This guide explains the valid ways a company may execute documents under Section 66 — with or without a common seal — and the requirements for executing a deed under Section 67."
...
appliesTo: "Company secretaries, directors, lawyers, and business owners who need to execute contracts, deeds, or statutory documents on behalf of a Malaysian company (Sdn Bhd or Bhd)."

faq:
  - q: "Does a Malaysian company still need to have a common seal?"
    a: "No. Section 61(1) of the Companies Act 2016 states that a company 'may or may not have a common seal' — having one is now optional. However, if another written law (for example, dealings at the Land Office) requires the use of a common seal, the company may still adopt one when needed. SSM confirms in its FAQ Part G that the decision not to have a common seal does not override requirements under other written laws."
  - q: "How many signatories are needed to execute a document without a common seal?"
    a: "Two authorized officers, one of whom must be a director (Section 66(2)(a)). Exception: for a company that has only one director, that director may sign alone but in the presence of a witness who attests the signature (Section 66(2)(b))."
  - q: "Who is an 'authorized officer'?"
    a: "Under Section 66(5), an authorized officer means a director of the company, a secretary of the company, or any other person approved by the Board of Directors. This means the Board may authorize specific staff to sign, provided one of the signatories remains a director."
  - q: "Does every contract and letter have to be signed by two officers?"
    a: "No. Section 66(6) defines 'document' as a document required to be executed by a written law, resolution, agreement or constitution in accordance with Section 66(1). Ordinary contracts may be made under Section 64 by any person acting under the company's authority, without needing two officers."
  - q: "How does a company execute a deed?"
    a: "Under Section 67(1), a document is validly executed as a deed if it is duly executed by the company AND delivered as a deed. Section 67(2) presumes that delivery has occurred as soon as the deed is validly executed, unless a contrary intention is proved."
