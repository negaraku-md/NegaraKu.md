...
summary: "An overview of the registers and records every Malaysian Sdn Bhd must keep under the Companies Act 2016, with the statutory section, location and update rule for each."

tier: "3"
mode: "practical"
contentType: "checklist"

answer: "A Malaysian Sdn Bhd must keep a register of members (s.50), a register of directors, managers and secretaries (s.57), a register of directors' shareholdings (s.59), a register of charges (s.362), a register of beneficial owners (s.60B), and records of members' resolutions and meetings (s.341). Most must be kept at the registered office, and each carries its own update rule and its own separate duty to notify SSM."
keyTakeaways:
