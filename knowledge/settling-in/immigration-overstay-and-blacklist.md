...
summary: "What happens when a Malaysian pass lapses — the compound fines, the newer day-rate schedule for Employment and Dependant Pass holders, what pushes a case to Enforcement, and how a re-entry ban or blacklist entry works."
...
1. **It is not open-ended.** Remaining beyond the Special Pass's validity is itself an overstay.
2. **Overstaying under a Special Pass is not eligible for the streamlined compound** — it goes straight to Enforcement.
...
1. **Settle everything first.** Pay any outstanding compound and make sure you actually departed within the window you were given.
2. **Confirm your status directly.** Ask the Immigration Department (in person, through your embassy, or via a licensed agent) whether you are blacklisted, on what ground, and for how long — there is no reliable online self-check for foreign passport holders.
3. **Appeal in writing** to the Immigration Department, setting out the circumstances and attaching proof (medical records, application receipts, flight records). This is often done through your embassy or a licensed immigration agent, especially from outside the country.
4. **Expect discretion, not entitlement.** The Department decides case by case, and courts have historically been reluctant to overturn immigration decisions — the remedy is largely administrative, not judicial.
...
- Read the related [Employment Pass](employment-pass), [dependant and social visit passes](dependant-social-visit-passes), and [Student Pass](student-pass) guides to keep the underlying pass valid in the first place.
