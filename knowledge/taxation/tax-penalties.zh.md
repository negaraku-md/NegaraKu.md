...
topicId: MY-TAX-0117
title: "马来西亚税务罚则与罪行参考"
seoTitle: "马来西亚税务罚则：罪行、法条、税率与优惠"
slug: "tax-penalties"
category: "taxation"
subcategory: ["tax-administration"]
summary: "横跨 Income Tax Act 1967、Sales Tax Act 2018、Service Tax Act 2018、Stamp Act 1949 与 Real Property Gains Tax Act 1976 的罪行、法条、罚则幅度与典型优惠。"
...
answer: "马来西亚的税务罚则坐落在五部各自独立的法令里，没有共同的级距。所得税跑的是 10% 的逾期缴付加征（s.103），外加就少收税额课的百分比罚款（s.113(2)）或未呈报的三倍税款（s.112(3)）。销售税与服务税采用 10-15-15 的逾期缴付阶梯，跨三个 30 天期，上限 40%，而逃税的代价是税款的 10 至 20 倍。印花税跑的是两级的逾期盖印花罚款。RPGT 对未呈报课以三倍税款罚款，逾期缴付则一律加征 10%。"
keyTakeaways:
  - "所得税逾期缴付只有 10%——那额外的 5% 在 Finance Act 2019（Act 823）删除 s.103(4)、(6) 与 (8) 时一并消失"
  - "销售税与服务税逾期缴付是三个 30 天期的 10%、15%、15%，所以依两部法令各自的 s.26，法定上限是 40%"
  - "SST 逃税的定价远高于所得税逃税——依 s.86（销售）或 s.71（服务），首次犯为税款的 10 至 20 倍"
  - "连续两年或以上未呈交所得税报表，定罪后依 s.112(1A)(b) 课三倍税款的特别罚款，或在不提控的情况下依 s.112(3) 课三倍税款"
  - "s.113(2) 罚款最高为少收税额的 100%；2025 年稽查框架改为按犯次适用 15% / 30% / 45%"
  - "印花税逾期盖印花自 2025 年 1 月 1 日起为两级——RM50 或 10%，其后 RM100 或 20%（Act 862 s.26）"
  - "ss.72B 至 72D 下新的印花税自评估罪行自 2026 年 1 月 1 日生效，包括一项相当于少收税额的罚款"
appliesTo: "需要就所得税、SST、印花税与 RPGT 上某一项具体合规失误估算下行代价的董事、财务经理与税务代理。"

faq:
  - q: "马来西亚所得税逾期缴付还是 10% 加 5% 吗？"
    a: "不是了。Section 103 如今只课单一的 10% 加征——(3) 项针对法定到期日应缴的税款，(5) 项针对连同通知书送达的评税项下税款，(7) 项针对拖欠已议定的分期。原先 s.103(4)、(6) 与 (8) 中的第二级加征已被 Finance Act 2019（Act 823）删除，而 LHDN 自己的罚则页面自 2020 年 1 月 1 日起只显示 10%。总监可依 s.103(9) 豁免。"
  - q: "SST 逾期缴付的罚款上限是多少？"
    a: "百分之四十。Sales Tax Act 2018 s.26(9) 与 Service Tax Act 2018 s.26(8) 各自订明第一个 30 天期 10%、第二个再加 15%、第三个再加 15%。此后并无进一步的期间，所以阶梯止于 40%。同样的 10-15-15 级距依 Service Tax Act s.26A(3) 适用于以 Form SST-02A 申报的进口应税服务。"
  - q: "这里的罚款与罚金有什么不同？"
    a: "罚金由法院在定罪后科处。罚款由总监或征收官在未提控的情况下以行政方式课征，而缴付罚款即排除就同一事实提控——这个模式在 ITA ss.112(3)、113(2) 与 113B(4)、RPGTA ss.29(3) 与 30(2)，以及 Stamp Act ss.72C(3) 与 72D(2) 中都写得很明确。几乎每一宗真实案件都是在罚款那一分项上了结的，而不是罚金。"
  - q: "罚款可以调低吗？"
    a: "可以，属酌情。ITA s.124(3) 容许总监减免或豁免罚款；s.103(9) 与 s.107C(11) 容许他基于充分理由豁免逾期缴付或预估的加征。Stamp Act s.47A(2) 容许征收官调低或豁免逾期盖印花罚款，而 ss.72C(4) 与 72D(3) 对新的自评估罚款作出同样规定。RPGTA s.40(3) 是对应条文。SST 罪行可依 s.95（销售）或 s.80（服务）以至多最高罚金的 50% 和解。"
  - q: "哪些失误根本不带罚金，只有加征？"
...
马来西亚没有单一的税务罚则级距。五部法令各跑各的架构，而同一个商业上的失误，在其中
