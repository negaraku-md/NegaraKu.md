...
category: "taxation"
subcategory: ["sst"]
summary: "How the business-to-business service tax exemption works group by group, and the invoice and record conditions that decide whether a claim actually holds."
...
The B2B exemption fails on the same condition almost every time: the service
