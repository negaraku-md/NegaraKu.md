...
summary: "When a Malaysian company must prepare contemporaneous transfer pricing documentation, the 14-day production deadline, the graduated s.113B penalty and the s.140A(3C) surcharge that applies even with no extra tax."
...
The 14 days is the part that ruins people. LHDN serves a notice under rule 5(3)
