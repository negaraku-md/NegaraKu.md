...
keyTakeaways:
  - "기준은 보고 연도 직전 재무연도의 연결 그룹 총수입 RM30억입니다"
  - "통지는 보고 재무연도의 마지막 날 이전에 제출해야 합니다 — 사람들이 놓치는 마감일이 바로 이것입니다"
  - "보고서는 보고 재무연도의 마지막 날로부터 12개월 이내에 제출합니다"
  - "제출은 통상의 세무 신고서가 아니라 OECD XML 스키마로 HiDEF를 통해 이루어집니다"
  - "보고서를 제출하지 않는 것은 제112A조에 따른 범죄로 RM20,000~RM100,000의 벌금 또는 6개월의 징역에 처해집니다"
  - "독립적인 마스터 파일 제출 의무는 없습니다 — 그룹 정보는 이전가격 규칙 2023(Transfer Pricing Rules 2023) 부칙 1(Schedule 1)에 담깁니다"
appliesTo: "대규모 다국적 그룹 내의 말레이시아 실체 및 고정사업장, 그리고 라부안 사업활동을 영위하는 라부안 실체."

faq:
  - q: "말레이시아의 CbCR 기준은 무엇입니까?"
    a: "보고 재무연도 직전 재무연도의 연결 그룹 총수입이 RM30억 이상인 것입니다. 이는 소득세(국가별 보고) 규칙 2016(Income Tax (Country-by-Country Reporting) Rules 2016)이 정한 링깃 기준이며, 글로벌 최저한세 목적으로 적용되는 EUR 7억 5천만 기준과는 별개입니다."
  - q: "CbCR 통지는 언제 제출해야 합니까?"
    a: "제6규칙에 따라 보고 재무연도의 마지막 날 이전입니다. 2021 과세연도부터 통지는 양식 e-C(Form e-C), 라부안 실체의 경우 양식 LE1(Form LE1), 또는 말레이시아 국세청(LHDN)의 공표 양식을 사용한 회사 레터헤드의 공식 서한으로 할 수 있으며, 제75조에 따라 서명하고 인편 또는 특송으로 전달합니다."
  - q: "말레이시아는 마스터 파일을 요구합니까?"
    a: "별도 제출로서는 아닙니다. 소득세(이전가격) 규칙 2023(Income Tax (Transfer Pricing) Rules 2023) 제4(2)(a)규칙은 동시 이전가격 문서화 내에 부칙 1(Schedule 1)에 명시된 다국적기업 그룹에 관한 정보를 요구합니다. 말레이시아 이전가격 지침 2024(Malaysia Transfer Pricing Guidelines 2024) 제11.7(a)항은 요구되는 모든 정보를 담은 그룹 마스터 파일을 부칙 1(Schedule 1) 대신 제출할 수 있도록 허용합니다."
  - q: "국가별 보고서를 제출하지 않으면 벌칙은 무엇입니까?"
    a: "소득세법(Income Tax Act 1967) 제112A조는 불이행을 범죄로 규정하며, 유죄 판결 시 RM20,000 이상 RM100,000 이하의 벌금 또는 6개월 이하의 징역, 또는 둘 다에 처합니다. 보고서를 제출했다는 입증 책임은 피고인에게 있으며, 법원은 30일 이내에 이행하도록 명할 수 있습니다."

verificationNeeded:
  - "P.U.(A) 409/2017의 라부안 대응 규정은 말레이시아 국세청(LHDN)에 의해 동일한 제6규칙 및 제7규칙 마감일을 갖는 것으로 인용되나, 라부안 규정 전문은 읽지 않았습니다"
  - "현재 공표된 IRBM 국가별 보고 지침(Country-by-Country Reporting Guidelines)은 2019년 1월 1일자로 말레이시아 국세청(LHDN) CbCR 페이지의 HiDEF 플랫폼 세부사항보다 앞섭니다 — 둘이 다른 경우 해당 페이지가 더 최신 출처입니다"

obligations:
  - what: "보고 법인 또는 비보고 법인 지위를 말레이시아 국세청(LHDN)에 통지"
    trigger: "financial-year-end"
    due: "보고 재무연도의 마지막 날 이전"
    authority: "LHDN"
    statute: "Income Tax (Country-by-Country Reporting) Rules 2016, rule 6"
    consequence: "미준수 시 해당 실체는 규칙 및 법에 따른 조치에 노출됩니다"
  - what: "국가별 보고서 제출"
    trigger: "financial-year-end"
    due: "보고 재무연도의 마지막 날로부터 12개월 이내"
    authority: "LHDN"
    statute: "Income Tax (Country-by-Country Reporting) Rules 2016, rule 7"
    consequence: "제112A조에 따라 RM20,000~RM100,000의 벌금 또는 6개월 이하의 징역, 또는 둘 다"
