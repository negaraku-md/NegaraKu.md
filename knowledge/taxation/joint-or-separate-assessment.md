...
summary: "The s.45(2) election explained as an arithmetic trade — one spouse relief and one rebate against a second personal relief and a second run up the rate scale."
...
Joint assessment is not a discount. It is a trade, and the arithmetic behind it
