...
keyTakeaways:
  - "기준액은 하나의 전국적 수치가 아니라 제1별표의 (3)란에서 그룹별로 정해집니다"
  - "그룹 M 교육과 그룹 H 1항 신용카드는 기준액이 영입니다 — 한 건의 과세 공급만으로 납세의무가 발생합니다"
  - "제12(2)조에는 두 가지 판단 기준이 있습니다: 이번 달로 끝나는 12개월과, 이번 달로 시작하는 12개월"
  - "제34조에 따라 납부가 면제된 수입도 여전히 과세 대상 서비스의 가액이며 여전히 기준액에 산입됩니다"
  - "납세의무가 발생한 달의 다음 달 말일까지 신청하십시오. 그렇지 않으면 관세청이 등록을 소급할 수 있습니다"
  - "판매세 등록은 총매출이 아니라 제조 활동에 대한 별도의 RM500,000 기준입니다"
appliesTo: "서비스세 기준액에 근접한 모든 사업체와, 판매세 납세의무를 검토하는 제조업체."

faq:
  - q: "말레이시아의 SST 등록 기준액은 얼마입니까?"
    a: "단일한 수치는 없습니다. 서비스세 기준액은 서비스세 규정(Service Tax Regulations 2018) 제1별표의 (3)란에서 그룹별로 정해지며, 영부터 RM1,500,000까지입니다. 판매세는 Sales Tax (Total Sale Value of Taxable Goods) Order 2018에 따른 자체 RM500,000 기준액이 있으며, 이는 귀하가 제조하는 상품의 판매가액을 기준으로 판단합니다."
  - q: "면제 수입이 SST 기준액에 산입됩니까?"
    a: "그렇습니다. 그리고 이것이 이 제도에서 가장 큰 대가를 치르는 오해입니다. B2B 면제, 비재검토 계약 면제, 민간 의료에서 말레이시아 시민에 대한 면제 같은 감면은 서비스세법(Service Tax Act 2018) 제34조에 따라 세금 납부의 면제로서 부여됩니다. 그 공급은 여전히 과세 대상 서비스이며, 제12(2)조는 모든 과세 대상 서비스의 총가액을 기준으로 판단합니다."
  - q: "서비스세 등록은 언제까지 신청해야 합니까?"
    a: "서비스세법(Service Tax Act 2018) 제13(1)조에 따라 납세의무가 발생한 달의 다음 달 말일까지입니다. 관세청은 귀하의 신청 다음 달 1일부로 등록합니다. 신청하지 않으면 제13(4)조에 따라 관세청장이 납세의무 발생일보다 이르지 않은 한 그가 정하는 날부터 등록할 수 있습니다."
  - q: "기준액 아래로 유지하기 위해 사업을 분할할 수 있습니까?"
    a: "할 수 없습니다. 제15조는 사업 활동의 분리가 인위적이라고 판단되는 경우, 사업들이 재정적·경제적·조직적 연결로 얼마나 긴밀히 결합되어 있는지를 고려하여, 관세청장이 여러 인격체를 하나의 과세대상자로 취급하도록 지시할 수 있게 합니다. 그 지시는 그가 지정하는 날부터 등록하도록 요구할 수 있습니다."
  - q: "각 서비스 그룹을 개별적으로 판단합니까?"
    a: "그렇습니다. 각 그룹은 (3)란에 자체 기준액을 가지므로, 두 그룹에서 수입이 있는 사업체는 각각을 그 그룹의 수치와 대조하여 판단합니다. 그룹 G 전문직은 내부적으로 합산하는 예외입니다 — 그룹 G 대상자는 하나 이상의 그룹 G 서비스의 합산 가액이 RM500,000을 초과하면 납세의무가 발생합니다."

verificationNeeded:
  - "14항부터 16항 이외의 그룹 I 항목에 대한 현행 기준액을 제1별표의 통합 재판본과 대조하여 확인할 것 — 여기의 수치는 통합 본문이 아니라 최초 관보에 게재된 P.U.(A) 214/2018과 인용된 개정 사항에서 읽은 것임"

obligations:
  - what: "서비스세 등록을 신청"
    trigger: "ongoing"
    due: "등록 대상 납세의무가 발생한 달의 다음 달 말일까지"
    authority: "RMCD"
    statute: "Service Tax Act 2018, s.13(1)"
    consequence: "제13(5)조에 따른 범죄; 관세청장은 제13(4)조에 따라 등록하고 소급할 수 있음"
  - what: "제조업체로서 판매세 등록을 신청"
    trigger: "ongoing"
    due: "등록 대상 납세의무가 발생한 달의 다음 달 말일까지"
    authority: "RMCD"
    statute: "Sales Tax Act 2018, s.13"
    consequence: "소급 등록 및 부과되었어야 할 세액에 대한 납세의무"
  - what: "과세 대상 매출이 서비스 그룹 기준액을 초과하면 서비스세에 등록"
    trigger: "threshold"
    criteria:
      - metric: "turnover"
        op: "gte"
        value: 500000
    due: "대부분의 서비스 그룹은 이동식 12개월 과세 대상 매출 RM500,000에서 등록하며, 기준액은 그룹별로 영부터 RM1,500,000까지임"
    authority: "RMCD"
