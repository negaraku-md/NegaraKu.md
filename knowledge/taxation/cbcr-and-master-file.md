...
summary: "The RM3 billion CbCR threshold, the notification deadline that falls on the last day of the financial year, the 12-month filing deadline, and why Malaysia has no standalone Master File obligation."
...
answer: "Country-by-country reporting applies to a multinational enterprise group with total consolidated group revenue of at least RM3 billion in the financial year preceding the reporting financial year, where one of its constituent entities is resident in Malaysia or is a Malaysian permanent establishment. Notification is due on or before the last day of the reporting financial year and the report itself within 12 months after that day. Malaysia has no separate Master File filing obligation."
keyTakeaways:
...
The deadline that catches groups is not the filing deadline. It is the
