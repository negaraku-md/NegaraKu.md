---
topicId: MY-TAX-0053
title: "工业建筑物减免：究竟什么才符合资格"
seoTitle: "马来西亚工业建筑物减免：IBA 规则"
slug: "industrial-building-allowance"
category: "taxation"
subcategory: ["deductions-and-allowances"]
summary: "paragraph 63 的定义与那些经延伸而被视为工业用途的建筑物、2016 年起生效的出租限制，以及购入建筑物时的合格开支陷阱。"
...
answer: "工业建筑物减免为用作 Income Tax Act 1967 Schedule 3 paragraph 63 下工业建筑物的建筑物之资本开支提供宽减，或依那些把定义延伸至医院、研究建筑物、出口仓库、酒店、机场、学校与员工宿舍的各段而适用。初始减免为合格建筑开支的百分之十，常年减免为百分之三，因此一栋普通的工业建筑物要用三十个课税年才摊销完毕。"
keyTakeaways:
  - "Paragraph 63 只列出六种用途——工厂、码头或埠头、公共仓储仓库、水电或电讯事业、农场与矿场"
  - "Paragraph 65(3) 直接排除住宅、零售店铺、陈列室与办公室"
  - "Paragraph 37A 至 37H 与 42 至 42C 把这项待遇延伸至医院、研究建筑物、出口仓库、获批服务项目、注册酒店、机场、赛车场、员工宿舍、托儿、学校与培训建筑物"
  - "自 2016 课税年起，paragraph 16B 就上述延伸类别中用于出租房产的建筑物拒绝给予减免，另有十分之一楼面面积的容差"
  - "购入建筑物的合格开支是购价，包含律师费、印花税与附带费用，但不包含土地"
  - "若买卖协议没有把土地与建筑物分开列出，就需要一份估值，而律师费也必须按比例分摊"
  - "若该建筑物在下一个课税年并未用作工业建筑物，paragraph 13(d) 会以结余课税的方式把初始减免收回"
appliesTo: "兴建、购买或改建商业与工业处所的马来西亚公司，以及为其计算合格建筑开支的税务代理。"

faq:
  - q: "马来西亚的工业建筑物减免税率是多少？"
    a: "Schedule 3 paragraph 12 给予合格建筑开支十分之一的初始减免，paragraph 16 给予三百分之三的常年减免，也就是 3%。Public Ruling No. 3/2018 确认，除非某一特定段另有订明，标准税率即为 10% 与 3%。若干延伸类别改为每年 10%、为期十年。"
  - q: "办公大楼算工业建筑物吗？"
    a: "不算。Schedule 3 paragraph 65(3) 规定，用作住宅、零售店铺、陈列室或办公室的建筑物不是、也不得被视为工业建筑物。例外是在工业建筑物综合体内用于上述用途、且落在 paragraph 66 之下的建筑物，其不合格部分的成本不超过全体的十分之一。"
  - q: "我出租出去的厂房可以申索工业建筑物减免吗？"
    a: "延伸类别不行。自 2016 课税年起，subparagraph 16B(1) 就与 paragraph 37A、37B、37C、37E、37F、37G、37H、42A、42B 与 42C 相关的开支，在该建筑物或其一部分用于出租房产时，拒绝给予 paragraph 12 与 16 下的减免。若出租部分不超过楼面面积的十分之一，整栋建筑物仍然符合资格；超过之后，减免即限于未出租的楼面面积。"
  - q: "我买下一栋现有建筑物时，合格开支是多少？"
    a: "Schedule 3 subparagraph 3(2) 把它定为该建筑物的购价。Paragraph 70 包含买方因该项购买而付出的律师费、印花税与其他附带开支，但不包含土地或随之购入之土地权益的价格。自 2005 课税年 paragraph 3A、4 与 5 的旧限制被废除以来，这一直是规则。"
  - q: "如果协议没有把土地价格与建筑物价格分开呢？"
    a: "Public Ruling No. 3/2018 要求取得估值及产业服务局或专业估值师的估值以确立这两个数字。附带费用随后必须按同一比例在土地与建筑物之间分摊，因为只有与建筑物有关的那一部分构成合格建筑开支。"
  - q: "卖方的税务折余价值对买方要紧吗？"
...
一家公司以 RM1.2 million 买下一间厂房，并按 RM1.2 million 申索工业建筑物减免。两年后稽查把申索调整到五十万出头，把此后每一年的超额部分加回去，还处以罚款。建筑物本身什么都没变。这家公司只是按一个法令从来不容许它使用的数字申索而已。
