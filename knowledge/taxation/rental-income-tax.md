...
summary: "When a letting commences for tax, why expenses incurred to get the first tenant are never deductible, and what happens in the gap between tenants."
...
answer: "Rental income is taxed under s.4(d) of the Income Tax Act 1967 unless the letting is run as a business under s.4(a). A s.4(d) letting commences on the date the property is first let; a s.4(a) letting commences when it is ready to be let. Expenses incurred to obtain the first tenant are initial expenses and are never deductible under either paragraph."
keyTakeaways:
...
The single most common error on a Malaysian rental computation is claiming the
