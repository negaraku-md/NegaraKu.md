...
keyTakeaways:
  - "단일한 부동산 양도소득세 세율 체계는 없습니다 — 별표 5는 세 개의 편(Part)으로 나뉘며, 4년차부터 크게 갈라집니다"
  - "말레이시아 시민권자와 영주권자는 6년차부터 0%를 내고, 회사와 비시민은 10%를 냅니다"
  - "비시민 개인과 외국 회사는 만 5년간 30%를 내며, 4년차와 5년차에도 세율이 낮아지지 않습니다"
  - "취득가액은 부대비용만큼 증가하지만, 보험금 수령액·손해배상금·몰수된 계약금만큼 감소합니다"
  - "양도가액은 가치 증대 지출·소유권 방어 비용·양도 부대비용만큼 감소합니다"
  - "부동산 취득을 위해 차입한 자금의 이자는 공제되지 않습니다"
  - "개인은 RM10,000 또는 과세 대상 양도차익의 10% 중 큰 금액을 별표 4 면제로 받지만, 회사는 받지 못합니다"
appliesTo: "말레이시아 부동산 양도에 대한 부동산 양도소득세를 계산하는 부동산 소유자, Sdn Bhd 이사, 부동산 양도 담당 사무원 및 회계사."

faq:
  - q: "말레이시아에서 5년이 지난 후의 부동산 양도소득세율은 얼마입니까?"
    a: "이는 전적으로 누가 양도하는지에 따라 달라집니다. 말레이시아 시민권자 또는 영주권자는 6년차 이후의 양도에 대해 0%를 내며, 이는 2022년 1월 1일 이후의 양도에 적용되어 온 기준입니다. 말레이시아에 설립된 회사는 10%를 냅니다. 비시민 개인, 외국 회사 또는 비시민 유산의 유언집행자도 10%를 냅니다. 0%로 끝나는 단일 세율 체계만 제시하는 안내 자료는 제1편(Part I)만을 설명하는 것입니다."
  - q: "부동산 양도소득세 양도차익에서 개보수 비용을 공제할 수 있습니까?"
    a: "자산의 가치를 증대하거나 유지하기 위해 전적으로 또한 배타적으로 지출된 비용은, 양도 시점의 자산 상태에 반영되어 있는 한 별표 2 제5(1)(a)항에 따라 양도가액에서 공제됩니다. 주방 개보수와 건물 증축은 이에 해당합니다. 지속적인 가치 증대를 남기지 않는 일상적 수리는 일반적으로 해당하지 않으며, 부동산 구입에 사용된 대출의 이자는 명시적으로 인정되지 않습니다."
  - q: "구입 시 납부한 인지세는 부동산 양도소득세에서 공제됩니까?"
    a: "그렇지만 계산의 반대편에서 적용됩니다. 부동산을 취득할 때 납부한 인지세, 법률 비용, 감정평가 비용 및 중개 수수료는 별표 2 제4(1)항에 따라 취득가액에 가산되는 부대비용입니다. 반면 매각 시 발생한 비용은 양도가액에서 공제됩니다. 둘 다 과세 대상 양도차익을 줄이지만, 이를 잘못된 항목에 기입하면 산술적으로는 달라지는 것이 없더라도 세무조사에서는 모든 것이 달라집니다."
  - q: "부동산 양도소득세의 보유 기간은 어떻게 계산됩니까?"
    a: "취득일부터 양도일까지이며, 이는 통상 각각의 매매계약 체결일입니다. 2021년 3월 15일에 취득한 부동산은 2026년 3월 15일에 6년차에 진입하므로, 2026년 6월 20일의 양도는 6년차 양도입니다. 세율은 매 주년마다 한 단계씩 낮아지므로, 경계 전후 몇 주 차이만으로도 세율이 5~10퍼센트포인트 달라질 수 있습니다."
  - q: "취득자는 정말로 대금의 일부를 유보해야 합니까?"
    a: "그렇습니다. 제21B조에 따라 취득자는 양도 후 60일 이내에 대가의 일정 비율을 국세청장에게 유보하여 납부해야 합니다 — 제1편 양도자의 경우 3%, 3년 이내에 양도하는 회사의 경우 5%이고 4년차부터는 3%, 양도자가 제3편에 해당하는 경우 7%입니다. 이를 이행하지 않으면 매도인이 아니라 취득자가 미납액에 대해 10% 증액을 부담하게 됩니다."

verificationNeeded: []
obligations:
  - what: "부동산 양도에 대한 부동산 양도소득세 신고서를 제출하고 세액을 납부"
    trigger: "change"
    withinDays: 60
    due: "양도일로부터 60일 이내"
    authority: "LHDN"
    statute: "Real Property Gains Tax Act 1976, s.13 and s.21B"
    consequence: "제29(3)조에 따라 세액의 최대 3배 벌금, 그리고 제21B(2)조에 따라 취득자에 대한 10% 증액"
