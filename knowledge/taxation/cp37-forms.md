...
summary: "Directory of every LHDN withholding tax remittance form, the section it serves, its current version, and the rule for when the money must reach LHDN."
...
Nobody chooses a withholding tax form from a description of the payment. You
