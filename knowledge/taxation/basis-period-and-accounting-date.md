...
summary: "How section 21A fixes a company's first basis period, why a first-year Sdn Bhd can have no year of assessment at all, and what to file when the accounting date moves."
...
answer: "A company's basis period is set by section 21A of the Income Tax Act 1967. If the first accounts close in the same calendar year operations began, that period is the first basis period. If they close in the following year, there is no basis period for the first year of assessment at all. When the accounting date later moves, the year of the change is a failure year and the Director General directs the basis periods for that year and the next."
keyTakeaways:
...
A Sdn Bhd incorporated in March that closes its first accounts on 30 June the
