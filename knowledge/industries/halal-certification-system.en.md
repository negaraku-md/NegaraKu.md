---
topicId: MY-IND-0008
title: "Malaysia's Halal Certification System"
seoTitle: "Malaysia Halal Certification: JAKIM, MS 1500 & Digital SPHM"
slug: "halal-certification-system"
category: "industries"
subcategory: ["halal"]
summary: "Halal certification in Malaysia is issued by JAKIM together with the state Islamic religious authorities (MAIN/JAIN), based on the MS 1500 standard and the Malaysia Halal Certification Procedure Manual. Since 5 May 2025, the entire application process for the Malaysia Halal Confirmation Certificate (SPHM) has been conducted fully digitally through the MYeHALAL system."
...
answer: "In Malaysia, only the Department of Islamic Development Malaysia (JAKIM) and the state Islamic religious authorities (MAIN/JAIN) have the power to issue the Malaysia Halal Confirmation Certificate (SPHM). Certification is voluntary — no law makes it compulsory — but once a product is labelled halal, it must be genuinely certified under the Trade Descriptions Act 2011. Nine schemes are offered, each based on Malaysian standards and the Malaysia Halal Certification Procedure Manual (Domestic) 2020, and since 5 May 2025 all applications are made fully digitally through MYeHALAL with self-printed certificates (e-Cert)."
keyTakeaways:
  - "Only JAKIM and MAIN/JAIN may issue Malaysian halal certificates; 'self-declaration' or private-company halal logos are not valid"
  - "Halal certification is voluntary — no law requires any party to apply for it"
  - "There are nine certification schemes, from food and drink to slaughterhouses and medical devices"
  - "The processing fee is RM20, and the annual certification fee ranges from RM100 (micro) to RM1,000 (large industry)"
  - "Since 5 May 2025, the SPHM is issued electronically (e-Cert) and self-printed by applicants through MYeHALAL"
appliesTo: "Entrepreneurs, SMEs, brand owners, exporters and companies wishing to obtain or renew a Malaysian halal certificate, as well as anyone who wants to understand how the country's halal certification system works."

faq:
  - q: "Who can issue a halal certificate in Malaysia?"
    a: "Only JAKIM and the state Islamic religious authorities (State Islamic Religious Council / State Islamic Religious Department, MAIN/JAIN) are recognised as competent authorities. Halal certificates or logos issued via 'self-declaration' or by private companies are not recognised under Malaysian law."
  - q: "Is a halal certificate mandatory to run a food business in Malaysia?"
    a: "No. JAKIM affirms that halal certification is voluntary and no law requires any party to apply for it. However, if a product or premises is labelled or promoted as 'halal', it must be genuinely certified, because the Trade Descriptions Act 2011 regulates the use of the term halal."
  - q: "How much does it cost to apply for a halal certificate?"
    a: "The processing fee is RM20 for domestic applications (RM200 for foreign-registered companies manufacturing within the country). The annual certification fee depends on industry size: RM100 (micro), RM400 (small), RM700 (medium) and RM1,000 (large). Food premises are charged RM100 per premises per year."
  - q: "How long is a halal certificate valid?"
    a: "It depends on the scheme: one year for slaughterhouses; two years for food and drink and food premises; and three years for cosmetics, pharmaceuticals, consumer goods, logistics, contract/OEM manufacturing and medical devices. Eligible and committed certificate holders may be offered a validity period of up to five years."
  - q: "What are MYeHALAL and e-Cert?"
    a: "MYeHALAL is the official online system for SPHM applications at www.halal.gov.my. Since 5 May 2025, certificates are issued electronically (e-Cert) and applicants can print their own SPHM through the system, without waiting for a physical printed copy."
  - q: "Can I use a consultant to deal with JAKIM?"
