...
summary: "How Malaysia certifies its palm oil as sustainable — the mandatory MSPO scheme, the voluntary RSPO standard, the EU Deforestation Regulation, and the US forced-labour import ban that reshaped the trade."
...
appliesTo: "Exporters, plantation managers, smallholders, sustainability officers, buyers and analysts working with Malaysian palm oil."

faq:
  - q: "Is MSPO certification compulsory in Malaysia?"
    a: "Yes. The government declared MSPO mandatory in 2017 and phased it in through the end of 2019 for all plantations, organised and independent smallholders, and mills. It is a national requirement, not an optional label."
  - q: "What is the difference between MSPO and RSPO?"
    a: "MSPO is Malaysia's government-owned, mandatory national scheme run by MPOCC. RSPO is a voluntary, multi-stakeholder global standard formed in 2004 that buyers demand for premium and European markets. Many Malaysian producers hold both."
  - q: "Does MSPO or RSPO certification satisfy the EU Deforestation Regulation?"
    a: "Not automatically. The EUDR requires operators to prove products are deforestation-free with plot-level geolocation and their own due diligence. Certification helps supply that evidence but does not replace the legal due-diligence obligation."
  - q: "When does the EU Deforestation Regulation take effect for palm oil?"
    a: "After two delays, it applies to large and medium operators from 30 December 2026, and to micro and small enterprises from 30 June 2027. The deforestation cut-off date is 31 December 2020."
...
| Regime | Type | Owner / authority | Applies to | Key trigger |
|---|---|---|---|---|
| MSPO (MS 2530:2022) | Mandatory national scheme | MPOCC (government-owned) | All Malaysian growers, smallholders, mills | Legal requirement to operate |
| RSPO | Voluntary global standard | Roundtable on Sustainable Palm Oil | Members / supply chains that opt in | Buyer and market demand |
| EU Deforestation Regulation (EUDR) | Mandatory import law | European Union | Anyone placing covered goods on the EU market | Deforestation-free proof after 31 Dec 2020 |
