...
summary: "Malaysia became Southeast Asia's fastest-growing data centre market from 2023 onward, drawing tens of billions in hyperscale investment to Johor. This guide covers what pulled the capital in, the incentives behind it, and the power and water limits now shaping which projects get approved."
...
answer: "Malaysia attracted RM184.7 billion in data-centre-related investment from 2021 to December 2024, with Johor holding around 80% of operational capacity. The pull was cheap land and power next to a supply-constrained Singapore, plus tax incentives under the DESAC scheme. Growth has now collided with power and water limits: total energy-supply applications already exceed 11,000 MW, and since February 2026 the government has restricted approvals for new non-AI data centres."
keyTakeaways:
  - "Roughly RM184.7 billion in data-centre-related investment was recorded from 2021 to December 2024 (MIDA)."
  - "Johor accounts for about 80% of Malaysia's operational data centre capacity."
  - "Data centre power demand could exceed 5,000 MW by 2035 — around 40% of Peninsular Malaysia's current capacity."
  - "Since February 2026, approvals for new non-AI data centres have been restricted over power and water strain."
  - "Tax incentives under the DESAC scheme are now conditional on MITI sustainability guidelines published 30 December 2024."
appliesTo: "Investors, operators, policymakers, and analysts tracking Malaysia's digital infrastructure sector"

faq:
  - q: "Why did data centre investment concentrate in Malaysia, and specifically Johor?"
    a: "Johor offered cheaper land and electricity directly across the Causeway from Singapore, which paused approvals for large data centre developments between 2019 and 2022. That combination redirected hyperscale demand into Johor, which now holds roughly 80% of Malaysia's operational capacity."
  - q: "What incentives are available to data centre and cloud operators?"
    a: "Tax incentives are offered under the Digital Ecosystem Acceleration (DESAC) scheme, a government programme under which MIDA receives the incentive applications. Applications received up to 31 December 2027 are subject to the sustainability conditions in MITI's 2024 guidelines."
  - q: "Is there a moratorium on new data centres in Malaysia?"
    a: "There is no blanket ban, but since February 2026 the government has restricted approvals for new data centres that are not AI-related, citing pressure on power and water resources."
  - q: "How much power and water does a data centre use?"
    a: "A single 100 MW facility can consume around 4.2 million litres of water daily for cooling. Sector-wide, data centre electricity demand could exceed 5,000 MW by 2035."
  - q: "What sustainability rules must new data centres meet?"
    a: "MITI's Guidelines for Sustainable Development of Data Centre (30 December 2024) require operators to declare design PUE, WUE and CUE against ISO/IEC 30134 standards, and to consider Peninsular Malaysia sites with a water stress index (WSI) of less than 0.8, as the guideline words its siting condition."
...
In 2019, Singapore stopped approving large new data centres. Within four years, the servers it turned away had built a new industry twenty minutes across the Causeway — and Johor went from a quiet Malaysian state to the busiest data centre market in Southeast Asia.
