...
summary: "Malaysia runs two parallel healthcare systems under a single ministry: a heavily subsidised public network of government hospitals and klinik kesihatan, and a fee-for-service private sector priced at market rates. Who pays what depends less on the illness than on who you are — citizen, permanent resident, foreign worker, expatriate or tourist."

tier: "2"
mode: "practical"
contentType: "guide"

answer: "Malaysia has two healthcare systems under one Ministry of Health (KKM): a heavily subsidised public system — government hospitals and klinik kesihatan — that citizens and permanent residents use for a fraction of its real cost, and a private system of hospitals and clinics billed at full market rates. Citizens get the public subsidy almost automatically; foreigners pay a separate, higher fee schedule at public facilities or rely on mandatory or private insurance. Most residents move between both systems depending on the situation, not just their income."
keyTakeaways:
  - "One ministry runs both sides: MOH (Kementerian Kesihatan Malaysia, KKM) operates the public hospital and clinic network and also regulates and licenses every private hospital and clinic in the country — there is no separate public insurer or private regulator."
  - "The public system does most of the volume: MOH hospitals and klinik kesihatan together logged nearly 63 million outpatient attendances in 2023, against just over 4 million at private hospitals, per MOH's own Health Facts 2024 report."
  - "Private has more hospitals but far fewer beds: 212 private hospitals (18,779 beds) versus 138 MOH hospitals (40,348 beds) in 2023 — private facilities are typically smaller and more numerous, not bigger."
  - "Citizens and permanent residents are charged under the Fees Act 1951's citizen schedule; non-citizens are charged under a separate, higher schedule under the same Act — MOH publishes the current rates, which are revised periodically."
  - "Two government schemes plug specific gaps for lower-income households: PeKa B40 (screening plus up to RM20,000 in medical-device aid) and MySalam (up to RM8,000 for a listed critical illness), both tied to B40 cash-aid recipient status, not general citizenship."
  - "Documented foreign workers must hold SPIKPA hospitalisation insurance to renew their work permit; expatriates and tourists generally rely on private insurance bought on the open market instead."
appliesTo: "Anyone navigating healthcare in Malaysia — citizens and permanent residents choosing between a klinik kesihatan and a private GP, foreign workers whose employer must insure them, and expatriates or tourists working out what a public hospital will and won't do for them."

verificationNeeded:
  - "Exact ringgit fee figures for citizens versus non-citizens at public hospitals (registration, ward classes, procedures) are set under the Fees Act 1951's Fees (Medical) Order and are revised periodically; MOH's own fee schedule page returned a server error on automated fetch at time of writing, so this article describes the mechanism (two-tier fee schedule by citizenship) without repeating specific figures that could not be reconfirmed at the primary source."
  - "SPIKPA's exact premium and annual coverage cap were not confirmed at an official primary source (only academic and insurance-broker secondary sources were found); this article describes the scheme's function — mandatory insurance tied to work-permit renewal, confirmed on the Immigration Department's own site — without stating an unverified premium or coverage amount."
...
A Malaysian retiree with chest pain calls an ambulance and is taken to the nearest government hospital, where a cardiologist sees him for a fee that covers a fraction of the actual cost. His neighbour, a work-permit holder from Indonesia with the same symptoms, is taken to the same hospital's emergency department — but the bill that follows is calculated on a completely different schedule, because the two of them are not, in the ministry's eyes, the same kind of patient.
