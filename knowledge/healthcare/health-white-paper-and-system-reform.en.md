---
topicId: MY-LIV-0097
title: "Health White Paper: Malaysia's Plan to Overhaul Its Health System"
seoTitle: "Malaysia Health White Paper: Health System Reform"
slug: "health-white-paper-and-system-reform"
category: "healthcare"
subcategory: ["reformasi"]
summary: "The Health White Paper, passed by the Dewan Rakyat in 2023, charts a 15-year reform of Malaysia's health system, including new ways to finance healthcare. Yet its implementation remains stalled due to the absence of an official oversight body."
...
answer: "The Health White Paper is a policy document from Malaysia's Ministry of Health (MOH) that was passed by the Dewan Rakyat on 15 June 2023 via a voice vote. It sets out four pillars and a 15-year reform strategy to correct the public-private imbalance, separate MOH's roles as regulator and purchaser from that of service provider, and raise public health financing to 5% of GDP. Since 2023, progress has been slow because the key implementing body and financing mechanisms have yet to be established."
keyTakeaways:
  - "The Health White Paper was passed by the Dewan Rakyat on 15 June 2023 via a voice vote after being debated by 28 members of Parliament."
  - "It targets a 15-year reform built on four pillars: service delivery, promotion/prevention, sustainable financing, and governance."
  - "MOH is proposed to relinquish its provider and purchaser roles while retaining its regulator role; a non-profit Strategic Purchaser would manage the health fund."
  - "Publicly managed health financing is targeted to rise from roughly 2.5% to 5% of GDP."
  - "As of the end of 2025, an independent oversight body has not been established and the new financing is still under study."
appliesTo: "Malaysians, patients, healthcare workers, policymakers, and anyone wanting to understand the direction of the country's health reform"

faq:
  - q: "When was the Health White Paper passed?"
    a: "It was tabled in Parliament in mid-June 2023 and passed by the Dewan Rakyat on 15 June 2023 via a voice vote, after being debated by 28 members of Parliament. It was tabled by the then Health Minister, Dr Zaliha Mustafa."
  - q: "Does the Health White Paper raise government hospital fees?"
    a: "Not automatically. Existing fees remain low (for example, RM1 for outpatients and RM5 for specialist treatment). The White Paper states that any review of fees must go through transparent analysis and public engagement, while maintaining a safety net for lower-income groups."
  - q: "What is the proposed national health insurance scheme?"
    a: "MOH is studying a contributory financing scheme co-funded by employees, employers and the government — government-run, non-profit, and anchored in shared responsibility. It is still at the study stage and has not been implemented."
  - q: "Does this reform mean healthcare is being privatised?"
    a: "The government insists it is not. Initiatives such as Rakan KKM are framed as a model to retain specialists in the public sector, not privatisation, although some observers remain cautious about its long-term effects."
