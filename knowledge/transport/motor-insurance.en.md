---
topicId: MY-LIV-0007
title: "Motor Insurance in Malaysia: Why Third-Party Cover Is Mandatory and How It Ties to Road Tax"
slug: "motor-insurance"
category: "transport"
subcategory: ["vehicles-tolls"]
summary: "Malaysian law mandates only one type of motor insurance cover — third party, under the Road Transport Act 1987 — while third party, fire & theft and comprehensive are optional add-ons. This article explains what each type covers, why it is mandatory, and why road tax cannot be renewed without it."

tier: "3"
mode: "practical"
contentType: "guide"

answer: "Third-party insurance is the only type of motor insurance mandated in Malaysia, under Section 90 of the Road Transport Act 1987. It covers your liability towards other people — injury, death or damage to third-party property — but does not cover your own vehicle. Third party, fire & theft and comprehensive insurance are optional cover added on top of this minimum requirement. JPJ checks insurance status during the Motor Vehicle License (road tax) renewal process, so road tax cannot be renewed without a valid policy for the period applied for."
keyTakeaways:
  - "Only third-party insurance is mandated by law in Malaysia, under Section 90 of the Road Transport Act 1987 (Act 333)"
  - "Third-party insurance pays only your liability towards other people — injury, death or damage to third-party property — not damage to your own vehicle"
  - "Third party, fire & theft adds cover for your own vehicle if it is burnt or stolen, but not for accidents you cause"
  - "Comprehensive insurance is the only type that covers damage to your own vehicle from an accident, alongside third-party liability, fire and theft"
  - "JPJ mandates proof of valid insurance for the Motor Vehicle License (LKM) period applied for before road tax can be renewed"
  - "Bank Negara Malaysia has coordinated a phased shift in motor premium pricing from a fixed tariff to risk-based pricing since 1 July 2016"
...
revisions:
  - version: "0.1"
    date: 2026-07-24
    change: "Draf awal. Keperluan Seksyen 90 disahkan melalui portal rasmi JPJ (halaman Akta 333 dan Panduan Pembaharuan LKM); jenis perlindungan disahkan melalui PIAM (Persatuan Insurans Am Malaysia); peralihan penetapan premium disahkan melalui pengumuman Bank Negara Malaysia."
    reviewer: null
sensitivity: "none"
...
You can legally drive a car that has never been washed, has worn-out tyres and a broken air conditioner. But driving without a single piece of paper — a third-party insurance policy — is a criminal offence.
