---
topicId: MY-GLO-0047
title: "Malaysian Anti-Corruption Commission (SPRM / MACC)"
seoTitle: "SPRM / MACC — Malaysian Anti-Corruption Commission"
slug: "suruhanjaya-pencegahan-rasuah-malaysia"
category: "glossary"
subcategory: ["governance"]
summary: "The MACC is the independent body that investigates, prevents and helps prosecute corruption in Malaysia's public and private sectors, established under the Malaysian Anti-Corruption Commission Act 2009 (Act 694)."
...
answer: "The MACC (Malaysian Anti-Corruption Commission), known in Malay as SPRM (Suruhanjaya Pencegahan Rasuah Malaysia), is the country's principal anti-corruption enforcement agency. It was established under the MACC Act 2009 (Act 694) to receive reports, investigate, prevent and help prosecute offences of corruption, abuse of power and related misconduct in the public and private sectors. For corporate readers, its greatest significance lies in Section 17A, which imposes criminal liability on commercial organisations for the failure to prevent corruption by persons associated with them."
keyTakeaways:
  - "Established under the MACC Act 2009 (Act 694), replacing the Anti-Corruption Agency — a body originally set up as the Anti-Corruption Agency in 1967 under the Prevention of Corruption Act 1967"
  - "Section 7 sets out the core functions: receiving reports, investigating, and examining the systems of public bodies to prevent corruption"
  - "Five oversight bodies ('check and balance' mechanism) monitor the MACC's operations — three created by the Act (Sections 13, 14, 15) and two administratively"
  - "Section 17A (in force 1 June 2020) imposes corporate liability; the only defence is 'adequate procedures'"
appliesTo: "Company directors, compliance officers, business owners, government suppliers and anyone managing corruption risk in Malaysia."

faq:
  - q: "What is the difference between SPRM and MACC?"
    a: "Both refer to the same body. SPRM is the Malay acronym (Suruhanjaya Pencegahan Rasuah Malaysia); MACC is the English acronym (Malaysian Anti-Corruption Commission). They are used interchangeably."
  - q: "When did Section 17A come into force?"
    a: "Section 17A came into force on 1 June 2020, two years after the 2018 amendment was passed, giving organisations time to prepare."
  - q: "What is the penalty under Section 17A?"
    a: "If convicted, a commercial organisation may be fined not less than 10 times the value of the bribe or RM1 million, whichever is higher, or imprisoned for up to 20 years, or both."
  - q: "What is the 'adequate procedures' defence?"
    a: "An organisation may defend itself if it proves that it had in place adequate procedures to prevent corruption. The guidance is the five T.R.U.S.T. principles in the Guidelines on Adequate Procedures issued by the Prime Minister's Department, dated 4 December 2018."
...
verificationNeeded:
  - "The 2024 enforcement figures (≫1,300 / 1,334 arrests) are taken from a Global Legal Insights secondary summary; confirm against SPRM's official annual statistics."
  - "The copy of Act 694 referenced is an official reprint hosted by Universiti Malaya; confirm against the official Federal Legislation copy (AGC/lom.agc.gov.my), including the 2018 amendment (Act A1567) that introduced Section 17A."
  - "The claim that the Section 17A model was inspired by the UK Bribery Act 2010 is a general characterisation; confirm the source if it is to be kept."
  - "Keep the GAP link (third-party hosted) or replace it with an official GIACC/Prime Minister's Department publication link if available."
updated: 2026-08-01
sources:
