...
category: "economy"
subcategory: ["glc"]
summary: "Government-linked investment companies control roughly a quarter of Bursa Malaysia's value and dominate banking, utilities, telecoms and plantations. This guide explains who they are, how big they are, and the reforms reshaping their role."
...
answer: "Eight government-linked investment companies (GLICs) managed roughly RM1.7 trillion at the 2021 launch of the PERKUKUH reform and, through the companies they control, account for about a quarter of Bursa Malaysia's market capitalisation. Their listed 'GLCs' anchor banking (Maybank, CIMB), power (Tenaga), telecoms (Telekom Malaysia) and plantations (Sime Darby). Two decades of reform — the 2004-2015 GLC Transformation Programme and the 2021 PERKUKUH initiative — have tried to sharpen their mandates while shrinking the state's direct footprint in business."
keyTakeaways:
  - "As at 30 September 2023, six major GLICs together held RM451.3 billion in local listed equities, equal to 25.6% of Bursa Malaysia's market capitalisation."
  - "The GLICs' pooled assets under management were put at about RM1.7 trillion when the PERKUKUH reform initiative was launched in 2021."
  - "Under the 2004-2015 GLC Transformation Programme, the flagship 'G20' companies grew their combined market value almost three times, from RM133.8 billion to RM386 billion at graduation on 28 July 2015 (peaking at RM431.1 billion on 7 April 2015)."
  - "In 2005, GLCs made up roughly 36% of Bursa's market capitalisation and about 54% of the benchmark composite index."
  - "In 2025, six GLICs pledged RM120 billion in domestic direct investment over five years and targeted RM100 billion in new Bursa market-cap growth."
appliesTo: "Investors, students, analysts and anyone trying to understand the size and structure of state ownership in Malaysia's listed economy."

faq:
  - q: "What is the difference between a GLC and a GLIC?"
    a: "A GLC (government-linked company) is a company with a primary commercial objective in which the Malaysian government holds a direct controlling stake. A GLIC (government-linked investment company) is a federal investment institution — such as Khazanah, EPF or PNB — that allocates its funds into those GLCs and other assets."
  - q: "Which are Malaysia's eight GLICs?"
    a: "The four sovereign-wealth-style funds are Khazanah Nasional, Kumpulan Wang Persaraan (KWAP), the National Trust Fund (KWAN) and Ministry of Finance Inc (MoF Inc). The four institutional investors are the Employees Provident Fund (EPF), Permodalan Nasional Bhd (PNB), Lembaga Tabung Haji (LTH) and Lembaga Tabung Angkatan Tentera (LTAT). Note that the Putrajaya Committee on GLC High Performance historically named a narrower list of five GLICs (EPF, Khazanah, LTAT, LTH and PNB), and the PERKUKUH reform is applied to six (adding KWAP)."
  - q: "Which sectors do GLCs dominate?"
    a: "GLICs hold controlling or major stakes across banking (Maybank, CIMB, RHB), electricity and gas utilities (Tenaga Nasional, Gas Malaysia), telecommunications (Telekom Malaysia, TIME dotCom) and plantations (Sime Darby, Boustead Plantations), alongside healthcare, transport and property."
  - q: "Is the government trying to reduce GLC dominance?"
    a: "Yes. The PERKUKUH initiative launched in 2021 set out 20 initiatives aimed at, among other things, giving each GLIC a clearer mandate, increasing private-sector participation ('crowding in') and streamlining the government's role in business, while directing more investment toward catalytic and developmental areas."
...
Buy almost any blue chip on Bursa Malaysia and you are, indirectly, doing business with the Malaysian government. The national power grid, the largest bank, the incumbent telco and one of the world's biggest palm-oil groups all share the same set of ultimate owners: a small cluster of state investment funds that between them steer roughly a quarter of the entire local stock market.
