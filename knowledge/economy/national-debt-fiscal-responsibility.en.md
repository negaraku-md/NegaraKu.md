---
topicId: MY-ECO-0031
title: "Malaysia's Federal Debt: What the Fiscal Responsibility Act Actually Caps"
seoTitle: "Federal Govt Debt & Fiscal Responsibility Act 2023 (Act 850)"
slug: "national-debt-fiscal-responsibility"
category: "economy"
subcategory: ["hutang"]
summary: "The Public Finance and Fiscal Responsibility Act 2023 (Act 850) sets a medium-term debt target of 60% of GDP, separate from the 65% statutory ceiling that governs specific borrowing instruments. This article explains what is capped, current debt levels, and how it is enforced."
...
answer: "Act 850 sets four medium-term fiscal objectives, including a debt level not exceeding 60% of GDP and a deficit not exceeding 3% of GDP. This differs from the 65% of GDP statutory debt ceiling under separate borrowing acts that cover only MGS, MGII and MITB. As at June 2025, Federal Government debt stood at RM1,304.2 billion or 64.7% of GDP, while statutory debt remained at 63.5% of GDP, below the 65% limit."
keyTakeaways:
  - "Act 850 (enforced 2023) targets a debt level not exceeding 60% of GDP over the medium term (3 to 5 years), not an immediate hard cap."
...
faq:
  ...
  - q: "What is the difference between the 60% limit and the 65% ceiling?"
    a: "The 60% target under Act 850 covers total Federal Government debt (domestic and external, all instruments) as a medium-term goal. The 65% statutory ceiling is set by separate borrowing acts and counts only three statutory instruments: MGS, MGII and MITB."
  - q: "What happens if the Government fails to meet the fiscal objectives?"
    a: "Under section 27 of Act 850, if the objectives and quantified values are not achieved, the Minister of Finance must table a fiscal adjustment plan that has to be approved by a motion of the Dewan Rakyat, explaining the reasons for the deviation, the corrective measures and the period to return to the target path."
  - q: "Are government guarantees counted as debt?"
...
Malaysia's Federal Government debt broke through RM1.3 trillion in 2025 — yet the frequently cited "64.7% of GDP" figure and the often-mentioned "60% limit" actually measure two different things. Understanding this distinction is key to reading the country's fiscal health accurately.
