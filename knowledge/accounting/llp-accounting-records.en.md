...
appliesTo: "Partners, compliance officers, and account preparers of a Limited Liability Partnership (LLP) in Malaysia, as well as anyone comparing an LLP's record-keeping obligations with those of a Sdn Bhd."

faq:
  - q: "Does an LLP need to file financial statements with SSM?"
    a: "No. The LLP Act 2012 contains no provision equivalent to section 248 or 259 of the Companies Act 2016 requiring financial statements to be prepared and filed. Instead, section 68 requires an LLP to lodge an annual declaration stating the opinion of two partners as to whether or not the LLP is able to pay its debts as they become due in the normal course of business. The figures behind that declaration must still be supported by accounting records under section 69."
  - q: "How long must an LLP's accounting records be kept?"
  ...
  - q: "Must an LLP's accounts be audited?"
  ...
  - q: "Who is responsible if an LLP's records are inadequate?"
    a: "Section 69(6) imposes an offence on the LLP AND every partner, with a fine of up to RM50,000 or imprisonment of up to six months or both. This is broader than the common assumption that only the 'compliance officer' bears the risk — a compliance officer under section 27 is only responsible for acts under sections 17, 19 and 20, not for section 68 or 69."
  - q: "Must an LLP use an approved accounting standard such as MFRS or MPERS?"
    a: "Section 69 does not refer to any approved accounting standard. It sets only a functional test — the records must enable a profit and loss account and balance sheet giving a true and fair view to be prepared. This differs from the Sdn Bhd framework, where the Companies Act 2016 ties financial statements to approved accounting standards. Nevertheless, LHDN tax requirements and bank lending practice often make preparing accounts in line with those standards a practical necessity."
  - q: "When must an LLP lodge its first annual declaration?"
...
revision: 0
verificationNeeded:
  - "Name and procedure of the online lodgement portal (MyLLP) — confirm the current portal and the annual declaration submission steps against the latest official SSM guidance."
  - "The audit exemption criteria for Sdn Bhd companies set by the Registrar (referred to only in general terms in the article) — confirm the current thresholds if specific figures are to be added."
revisions:
  - revision: 0
    date: 2026-08-08
