...
seoTitle: "Malaysian Institute of Accountants (MIA): Role, Membership, Powers"
...
faq:
  ...
  - q: "What does the designation C.A.(M) mean?"
    a: "C.A.(M) stands for Chartered Accountant Malaysia — the designation awarded by the MIA to qualifying members. Section 17 of the Act permits chartered members to use the letters 'C.A.(M)' after their names."
  - q: "What is the difference between an MIA practising certificate and an audit licence?"
    a: "A practising certificate is issued by the MIA and permits a member to offer public practice services. An audit licence, on the other hand, is issued by the Ministry of Finance under Section 263(2) of the Companies Act 2016, and can only be applied for after holding an MIA practising certificate."
  - q: "Who oversees the MIA?"
    a: "The MIA operates under the jurisdiction of the Ministry of Finance. For the audit of public interest entities, additional oversight is exercised by the Audit Oversight Board (AOB) under the Securities Commission."
...
Call yourself an "accountant" in Malaysia without registering with one particular body, and you are in fact committing a criminal offence. That body is the Malaysian Institute of Accountants — MIA — and it holds the sole authority to decide who counts as an accountant in this country.
...
4. Have the name proposed to the Ministry of Finance, which issues the **audit licence under Section 263(2) of the Companies Act 2016**.
