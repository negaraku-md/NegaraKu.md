...
keyTakeaways:
  - "CP22A는 고용 종료 최소 30일 전에 제출해야 합니다 — 퇴사 후 형식 절차가 아니라 사전 통지입니다."
  - "CP21은 근로자가 복귀 의사 없이 3개월을 초과하여 말레이시아를 떠나는 경우에 적용되며, 마찬가지로 30일 전입니다."
  - "근로자에게 지급할 금액은 90일간 또는 조세 완납 증명서가 발급될 때까지 유보해야 합니다."
  - "최종 임금은 다음 급여 주기가 아니라 고용 마지막 날에 지급 기일이 도래합니다 — 고용법 1955 제20조."
  - "법정 고용 종료 급부는 서면 산정과 함께 해당일로부터 7일 이내에 지급 기일이 도래합니다."
  - "근로자 명부는 기재 내용이 최소 6년간 열람 가능하도록 보존해야 합니다 — 제61(2)조."
  - "LHDN 통지 의무를 이행하지 않으면 RM200에서 RM20,000의 벌금 또는 최대 6개월의 징역에 처해집니다."
appliesTo: "외국인 전문가와 외국인 근로자를 포함하여 말레이시아 반도에서 모든 직원의 퇴사를 처리하는 인사, 급여, 재무 담당자."

faq:
  - q: "양식 CP22A는 언제 제출해야 합니까?"
    a: "고용 종료 최소 30일 전입니다. 종료가 사망으로 인한 경우, 통지는 고용주가 사망을 통보받은 후 30일 이내에 이루어져야 합니다. 2024년 9월 1일부터 조세 완납 증명서가 필요한 경우 MyTax 포털의 e-SPC 애플리케이션을 통해 제출합니다."
  - q: "고용주는 근로자의 최종 급여를 얼마나 유보해야 합니까?"
    a: "LHDN은 고용주가 근로자에게 지급할 금액을 90일간 또는 조세 완납 증명서를 받을 때까지 중 먼저 도래하는 시점까지 유보하도록 요구합니다. 이는 고용 종료 시, 사망 시, 그리고 근로자가 복귀 의사 없이 말레이시아를 떠나는 경우에 적용됩니다. 이는 최종 임금에 대한 고용법 기한과 병존하며, 실무상 그 시기를 우선합니다."
  - q: "90일 유보가 퇴사하는 모든 직원에게 적용됩니까?"
    a: "아닙니다. 이는 조세 완납 요건에 결부되며, 이 요건은 모든 퇴사자에게 자동으로 적용되는 것이 아니라 근로자의 세무 상태와 거주 지위에 따라 결정됩니다. 급여를 유보하기 전에 해당 사안이 조세 완납 증명서를 필요로 하는지 확인하십시오. 이 의무의 대상이 아닌 임금을 유보하는 것 자체가 고용법 위반이기 때문입니다."
  - q: "외국인 전문가가 사직하면 취업 패스는 어떻게 됩니까?"
    a: "패스는 후원 고용주에 결부되어 있으므로, 그대로 두지 말고 취소하거나 단축해야 합니다. 절차는 외국인 전문가 서비스국(ESD) 포털 또는 해당 부문 규제기관을 통해 처리됩니다. 구체적인 기한은 공개된 ESD 자료로 확인할 수 없었으며 ESD 또는 이민국에 직접 확인해야 합니다."

verificationNeeded:
  - "CP22A, CP21 및 90일 유보 의무의 근거가 되는 소득세법 1967 조항 번호는 확인되지 않았습니다 — LHDN 고용주 페이지는 조항을 인용하지 않고 의무만 명시하며, phl.hasil.gov.my는 연결을 거부했습니다. 이 법 본문을 확인하지 않고 제83(3)조나 제83(4)조를 인용하지 말 것."
  - "조세 완납 전에 금액을 지급한 고용주가 근로자의 미납 세금에 대해 개인적으로 책임을 지게 되는지 여부. 이는 온라인에서 널리 주장되고 유보 의무를 고려하면 타당하지만, 책임 이전에 관한 공식 발표는 찾을 수 없었습니다. 확인된 결과는 제120(1)조의 RM200에서 RM20,000의 벌금 또는 최대 6개월의 징역입니다."
  - "EPF가 직원별 종료 신고를 요구하는지 여부. KWSP의 공표된 의무는 개별 퇴사자가 아니라 고용주로서의 종료를 다루며, 실무상 입장은 기여가 단순히 중단되는 것으로 보입니다. KWSP에 확인할 것."
  - "개별 사직을 기록하는 PERKESO 채널은 ASSIST 포털이지만, 이에 대한 법정 기한은 찾을 수 없었습니다. 발견된 30일 기간은 양식 1A(Act 4)와 양식 SIP 3(Act 800)를 사용하는 고용주로서의 종료에 관한 것입니다."
  - "취업 패스 및 PLKS 취소 기한 — esd.imi.gov.my에서 확인할 수 없으며, 이 사이트는 자동 조회에 로그인 셸을 제공함."

obligations:
  - what: "양식 CP22A로 고용 종료를 LHDN에 통지"
    trigger: "change"
    withinDays: 30
    due: "고용 종료 최소 30일 전, 또는 근로자의 사망을 통보받은 후 30일 이내"
    authority: "LHDN"
    statute: "Income Tax Act 1967"
    consequence: "제120(1)조에 따라 RM200에서 RM20,000의 벌금 또는 최대 6개월의 징역"
  - what: "근로자가 말레이시아를 떠난다는 것을 양식 CP21로 LHDN에 통지"
    trigger: "change"
    withinDays: 30
    due: "근로자가 복귀 의사 없이 3개월을 초과하여 떠나는 경우, 예상 출발일 최소 30일 전"
    authority: "LHDN"
    statute: "Income Tax Act 1967"
    consequence: "제120(1)조에 따라 RM200에서 RM20,000의 벌금 또는 최대 6개월의 징역"
  - what: "조세 완납이 처리될 때까지 퇴사하는 근로자에게 지급할 금액을 유보"
    trigger: "change"
    withinDays: 90
    due: "90일간 또는 조세 완납 증명서를 받을 때까지 중 먼저 도래하는 때까지"
    authority: "LHDN"
    statute: "Income Tax Act 1967"
    consequence: "제120(1)조에 따라 RM200에서 RM20,000의 벌금 또는 최대 6개월의 징역"
  - what: "통상적인 고용 종료 시 최종 임금을 지급"
    trigger: "change"
    due: "근로계약이 종료되는 날까지"
    authority: "JTKSM"
    statute: "Employment Act 1955, s.20"
    consequence: "제99A조에 따라 최대 RM50,000의 일반 벌칙"
  - what: "근로자가 예고 없이 종료한 경우 최종 임금을 지급"
    trigger: "change"
    withinDays: 3
    due: "근로계약이 종료된 후 3일째 되는 날까지"
    authority: "JTKSM"
    statute: "Employment Act 1955, s.21(2)"
    consequence: "제99A조에 따라 최대 RM50,000의 일반 벌칙"
  - what: "법정 고용 종료 또는 일시해고 급부를 서면 산정 명세서와 함께 지급"
    trigger: "change"
    withinDays: 7
    due: "해당일로부터 7일 이내"
    authority: "JTKSM"
    statute: "Employment (Termination and Lay-Off Benefits) Regulations 1980, reg 11(1) and reg 12(1)"
    consequence: "규정 11(2) 및 규정 12(2)에 따른 범죄"
  - what: "외국인 가사 근로자의 고용 종료를 노동총국장에게 통지"
    trigger: "change"
    withinDays: 30
    due: "서비스 종료 후 30일 이내"
    authority: "JTKSM"
    statute: "Employment Act 1955, s.57B(1)"
    consequence: "제57B(3)조에 따라 최대 RM50,000의 벌금"
  - what: "퇴사가 정리해고 또는 VSS의 일부인 경우 양식 PK 제5부를 제출"
    trigger: "change"
    withinDays: 14
    due: "정리해고가 시행된 후 14일 이내"
    authority: "JTKSM"
    statute: "Employment Act 1955, s.63; P.U.(B) 430/2004"
    consequence: "제99A조에 따라 위반당 최대 RM50,000의 벌금"
  - what: "퇴사가 정리해고 또는 VSS의 일부인 경우 양식 PK 제6부를 제출"
    trigger: "change"
    withinDays: 30
    due: "정리해고가 시행된 후 30일 이내"
    authority: "JTKSM"
    statute: "Employment Act 1955, s.63; P.U.(B) 430/2004"
    consequence: "제99A조에 따라 위반당 최대 RM50,000의 벌금"
  - what: "근로자 명부 기재 내용을 열람용으로 보존"
    trigger: "ongoing"
    due: "기재된 모든 세부사항이 기재 후 6년 이상 열람 가능하도록"
    authority: "JTKSM"
