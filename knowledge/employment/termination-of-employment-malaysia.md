...
summary: "Malaysia has no at-will employment. The four lawful routes out, the statutory notice periods, payment in lieu, and when final wages legally fall due."
...
answer: "Malaysia has no at-will employment. Every dismissal must be for just cause or excuse, and an employee who disagrees may file a s.20 representation under the Industrial Relations Act 1967 within 60 days. Statutory notice under s.12(2) of the Employment Act 1955 is four weeks under two years of service, six weeks from two to under five, and eight weeks at five years or more, unless the contract provides longer."
keyTakeaways:
...
| Length of service at the date notice is given | Minimum notice |
| --- | --- |
...
| Scenario | Statute | Deadline |
| --- | --- | --- |
| Normal termination — contract expires or notice runs its course | s.20 | **On the day the contract terminates** |
