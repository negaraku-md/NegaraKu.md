---
topicId: MY-EMP-0049
title: "Employing a Foreign Domestic Worker in Malaysia"
seoTitle: "Employing a Foreign Domestic Worker (FDH) in Malaysia"
slug: "foreign-domestic-worker-employment-malaysia"
category: "employment"
subcategory: ["pekerja-asing"]
summary: "Foreign domestic workers are subject to a legal regime separate from ordinary foreign workers — permitted only from certain source countries, subject to employer income conditions and security bonds that vary by country, and exempted from mandatory EPF contributions and most of the Employment Act 1955."
...
appliesTo: "Malaysian citizens or permanent residents intending to employ a foreign domestic worker for household domestic work."

faq:
  - q: "Who is eligible to employ a foreign domestic worker?"
    a: "The employer must be a Malaysian citizen or permanent resident and meet the minimum income requirement set according to the domestic worker's source country. Each household is generally eligible for one worker; a second worker requires income above RM10,000 and a third above RM15,000, according to the Immigration Department."
  - q: "What is the minimum salary for a foreign domestic worker?"
    a: "For Indonesian domestic workers, the minimum salary is RM1,500 per month under the 2022 MoU between Malaysia and Indonesia. Other source countries set their own minimum salaries through MoUs and contract endorsement by the respective country's embassy or labour ministry."
  - q: "Does the employer need to contribute to EPF for a domestic worker?"
    a: "No. Domestic workers with valid permits are exempted from the mandatory 2% EPF contribution that takes effect from October 2025. EPF contributions for domestic workers remain voluntary only."
  - q: "Are foreign domestic workers protected by the Employment Act 1955?"
    a: "Only partly. Since amendments took effect on 1 January 2023, domestic employees are excluded from Part XII of the Employment Act except for the provision on one rest day per week."
  - q: "How much is the security bond that must be paid?"
    a: "The amount varies by source country — RM250 (Indonesia, Thailand, Cambodia), RM750 (the Philippines, Sri Lanka, India) and RM1,500 (Vietnam, Laos) according to the Immigration Department. The bond can be reclaimed when the worker returns, subject to conditions."
