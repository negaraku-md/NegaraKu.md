---
topicId: MY-LIV-0135
title: "Property Inheritance: Faraid and the Distribution Act"
seoTitle: "Property Inheritance in Malaysia: Faraid and the Distribution Act 1958"
slug: "property-inheritance-faraid-distribution"
category: "property"
subcategory: ["inheritance"]
summary: "How a house passes to heirs when its owner dies in Malaysia — faraid for the estates of Muslims and the Distribution Act 1958 for non-Muslims, plus the role of Amanah Raya and the Land Office. Presented neutrally from official sources."
...
answer: "Who inherits a house in Malaysia depends primarily on the deceased's religion. The estates of Muslims are divided according to faraid — fixed shares confirmed by the Syariah Court through a faraid certificate. The estates of non-Muslims who die without a will are divided under the Distribution Act 1958 (Act 300) in Peninsular Malaysia and Sarawak. Depending on the estate's value, its administration is handled by Amanah Raya, the Land Office (small estates), or the High Court."
keyTakeaways:
  - "The estates of Muslims are subject to faraid; the Syariah Court issues a faraid certificate confirming the list of heirs and each one's share."
  - "Non-Muslims who die without a will in Peninsular Malaysia and Sarawak are divided under the Distribution Act 1958 (Act 300)."
  - "Under faraid, a widow receives 1/8 if there are children and 1/4 if there are none; a widower receives 1/4 if there are children and 1/2 if there are none."
  - "A Muslim's will to a beneficiary who is not a faraid heir is limited to one third (1/3) of the estate."
  - "The estate's value determines the authority: small estates (below RM5 million) at the Land Office, simple estates (below RM600,000, movable property only) at Amanah Raya, and large estates at the High Court."
appliesTo: "Heirs, estate administrators, buyers of inherited property, and anyone planning the inheritance of a home in Malaysia."

faq:
  - q: "Does faraid apply to non-Muslims?"
    a: "No. Faraid applies only to the estates of Muslims. Non-Muslims who die without a will are subject to the Distribution Act 1958 in Peninsular Malaysia and Sarawak."
  - q: "What is a spouse's share under faraid?"
    a: "A widow receives one eighth (1/8) of the estate if the deceased left children, and one quarter (1/4) if there are no children. A widower receives one quarter (1/4) if there are children, and one half (1/2) if there are no children."
  - q: "Who administers a small estate in Malaysia?"
    a: "A small estate containing immovable property and valued below RM5 million is handled by the Land Administrator through the District Land Office, which issues a Distribution Order."
...
When someone dies in Malaysia, who inherits their house depends first on one fundamental matter: whether the deceased was a Muslim or a non-Muslim. Two different legal systems govern the answer, and both run through different authorities before any land title can change name.
