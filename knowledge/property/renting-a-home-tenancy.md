...
answer: "There is no single Malaysian law called a 'Tenancy Act.' A residential rental is an ordinary contract governed by the Contracts Act 1950, with the Specific Relief Act 1950 barring a landlord from self-help eviction and the Distress Act 1951 giving a landlord a court-ordered route to seize goods for unpaid rent. Because so little is fixed by statute, the tenancy agreement itself — not a default set of tenant rights — is what actually protects each side. Market practice bundles rent security into three separate sums (earnest deposit, security deposit, utility deposit), and the agreement legally becomes enforceable in court only once it is stamped through LHDN's stamp duty system within 30 days of signing."
keyTakeaways:
  - "Malaysia has no dedicated Residential Tenancy Act; a residential tenancy is an ordinary contract under the Contracts Act 1950, filled in by the Specific Relief Act 1950, the Distress Act 1951 and the Civil Law Act 1956"
  - "Because there is no default statute of tenant protections, whatever is NOT written into the signed tenancy agreement generally does not exist as a right — the document itself carries almost all the weight"
  - "The earnest deposit, security deposit and utility deposit are three separate sums bundled by market convention, not by law, and each is meant to cover a different risk"
  - "Stamp duty on a tenancy agreement is charged under the Stamp Act 1949 (First Schedule) on a sliding scale tied to the annual rent and the length of the lease, with a minimum duty of RM10 per instrument"
  - "An unstamped or under-stamped tenancy agreement is not void, but it cannot be used as evidence in court until the duty and any penalty are paid — which becomes a real problem the day a dispute starts"
  - "Section 7(2) of the Specific Relief Act 1950 bars a landlord from self-help eviction (changing locks, cutting utilities) — recovering possession from a tenant who won't leave requires a court order"
  - "A landlord can apply to court for a warrant of distress under the Distress Act 1951 to seize a tenant's movable property for unpaid rent, rather than confronting the tenant directly"
appliesTo: "Anyone renting or letting a residential property in Malaysia — tenants signing their first tenancy agreement, and landlords drafting one, in Peninsular Malaysia, Sabah or Sarawak."
...
Ask a landlord and a tenant in Malaysia which law protects them, and most will guess wrong. There is no "Residential Tenancy Act" to reach for — no single statute setting notice periods, capping deposits, or spelling out what a landlord can and can't do at move-out.
