---
topicId: MY-LIV-0138
title: "Strata Property Governance: JMB, MC and the Strata Management Tribunal"
seoTitle: "JMB vs MC & the Strata Management Tribunal in Malaysia"
slug: "strata-management-jmb-mc"
category: "property"
subcategory: ["strata"]
summary: "A guide to the layers of strata-living governance in Malaysia under the Strata Management Act 2013 — the difference between a Joint Management Body (JMB) and a Management Corporation (MC), the maintenance account versus the sinking fund, and the Strata Management Tribunal for disputes."

answer: "Condominiums and apartments in Malaysia are governed in two stages under the Strata Management Act 2013 (Act 757): a JMB (Joint Management Body), which is temporary and exists before strata titles are issued, followed by an MC (Management Corporation), which takes over once titles are registered. Both are required to collect maintenance charges and contribute to a sinking fund, and any dispute — especially unpaid charges — is brought to the Strata Management Tribunal, which hears claims of up to RM250,000."
keyTakeaways:
  - "A JMB is formed under Section 17(1) before the MC comes into existence, and dissolves three months after the MC's first AGM (Section 27(1))."
  - "An MC has broader powers than a JMB — it may own land, borrow money, sue and be sued — and does not include the developer."
  - "The sinking-fund contribution is equivalent to 10% of the maintenance charge (Section 52(3)); the MC's general meeting may set a higher rate but not less than 10% (Section 61(3))."
  - "The Strata Management Tribunal hears claims of up to RM250,000 under Section 105 (Fourth Schedule, Part 1); legal representation is not ordinarily allowed."
  - "Failing to comply with a Tribunal award is a criminal offence under Section 123 — a fine of up to RM250,000 or imprisonment for up to 3 years."
appliesTo: "Buyers, owners and occupiers of strata parcels (condominiums, apartments, serviced apartments), JMC/MC committee members, and management agents in Peninsular Malaysia."
...
faq:
  - q: "What is the difference between a JMB and an MC?"
    a: "A JMB (Joint Management Body) is a temporary body set up jointly by the developer and the buyers before strata titles are issued, under Section 17(1). An MC (Management Corporation) comes into existence once strata titles are registered, does not include the developer, and has broader powers including owning land and borrowing money."
  - q: "When must the JMB hand over to the MC?"
    a: "The JMB dissolves three months after the MC's first Annual General Meeting (AGM) under Section 27(1). The balances of the maintenance account and the sinking fund must be transferred no later than one month from the date of the first AGM (Section 27(2)(a))."
  - q: "How much can be claimed at the Strata Management Tribunal?"
    a: "The Tribunal hears monetary claims not exceeding RM250,000 (Section 105(1)). It cannot hear disputes involving title to land or an interest in land (Section 105(3))."
  - q: "Can I bring a lawyer to the Tribunal?"
    a: "Ordinarily, no party is allowed to be represented by a lawyer. An exception is made only where the case involves a complex question of law and one party would be severely prejudiced without representation."
  - q: "What happens if the losing party does not comply with the Tribunal award?"
    a: "Non-compliance with an award is a criminal offence under Section 123 — a fine not exceeding RM250,000 or imprisonment not exceeding 3 years or both, with a further fine of up to RM5,000 a day for a continuing offence. A complaint is made to the Commissioner of Buildings (COB)."
