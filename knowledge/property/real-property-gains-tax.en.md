---
topicId: MY-LIV-0136
title: "Real Property Gains Tax (RPGT) When Selling Property"
seoTitle: "Malaysia RPGT: Rates, Calculation & Seller Tax Filing"
slug: "real-property-gains-tax"
category: "property"
subcategory: ["cukai"]
summary: "A guide for property sellers in Malaysia on Real Property Gains Tax (RPGT) — rates by holding period and citizenship status, calculating the chargeable gain, automatic exemptions, and how to file with LHDN."
...
answer: "RPGT is a tax on the gain when you sell property in Malaysia, enforced by the Inland Revenue Board (LHDN) under the Real Property Gains Tax Act 1976. The rate declines with how long you hold the property — for citizens and permanent residents, it drops from 30% (years 1 to 3) to 0% after the fifth year; companies and non-citizens pay a minimum of 10%. You are allowed to deduct acquisition costs, legal fees, agent commission and improvement costs, and you enjoy an automatic exemption of RM10,000 or 10% of the gain (whichever is higher). Sellers must file the CKHT form with LHDN within 60 days of the disposal date."
keyTakeaways:
  - "RPGT is charged on the net gain from disposal, not the full sale price — acquisition costs and allowable expenses can be deducted."
  - "For citizens/PRs, the rate falls from 30% (years 1-3) to 20% (year 4), 15% (year 5) and 0% from the sixth year (effective 1 January 2022, LHDN)."
  - "Companies pay 30% (years 1-3), 20% (year 4), 15% (year 5) and 10% from the sixth year; non-citizens pay 30% (years 1-5) and 10% thereafter."
  - "Every individual enjoys an automatic exemption of RM10,000 or 10% of the chargeable gain, whichever is higher."
  - "Sellers must file the CKHT 1A form with LHDN within 60 days; buyers withhold part of the purchase price as tax security."
appliesTo: "Property owners in Malaysia who intend to or have recently sold land, a house or a unit, as well as agents and lawyers handling property disposals."

faq:
  - q: "Do I have to pay RPGT if I hold the property for more than five years?"
    a: "For individual Malaysian citizens and permanent residents, no RPGT is charged on disposals in the sixth year and beyond (0% rate). However, companies and non-citizens are still subject to a minimum of 10% even after five years."
  - q: "How is the disposal date determined?"
    a: "The disposal date is the date the written Sale and Purchase Agreement (SPA) is signed. If there is no written agreement, it is the date the transfer of title is completed or when full consideration is received, whichever is earlier."
  - q: "What is the once-in-a-lifetime exemption?"
    a: "Malaysian citizens and permanent residents can claim a full RPGT exemption on the disposal of one private residence, once only in their lifetime. The claim is made using the CKHT 3 form."
  - q: "Who pays the tax to LHDN — the seller or the buyer?"
    a: "The seller is liable for RPGT. But the buyer (or their lawyer) is required to withhold part of the purchase price — up to 3% for citizens — and remit it to LHDN as an advance payment on behalf of the seller."
  - q: "Can renovation costs be deducted?"
    a: "Yes. Expenses that enhance or preserve the value of the property, such as renovation and improvement costs, can be deducted provided they are supported by valid receipts and documents."
