...
category: "property"
subcategory: ["buying"]
summary: "A Malaysian home purchase runs on two parallel tracks — the Sale and Purchase Agreement track and the loan track — that meet at disbursement and finish at the Memorandum of Transfer. Knowing which lawyer does what, and where stamp duty actually gets charged, is what turns a stressful few months into a predictable one."
tier: "2"
mode: "practical"
contentType: "guide"

answer: "The process runs: booking fee to the vendor, then signing a Sale and Purchase Agreement (SPA) within roughly 14 days, then applying for a housing loan which the bank secures with its own Loan Agreement and a Charge (Form 16A) over the property, then your lawyer stamps and adjudicates duty on both documents at LHDN, then — once the balance purchase price and loan are disbursed — the Memorandum of Transfer (Form 14A) is executed and lodged at the Land Office to register you as the new owner. Stamp duty on the transfer is charged on a tiered scale (1% to 4%, higher of price or market value) under the Stamp Act 1949; a separate lawyer usually handles the SPA and the loan documentation, sometimes as one firm acting for both roles."
keyTakeaways:
  - "Two documents run in parallel, not one after another: the Sale and Purchase Agreement (transfer of the property) and the Loan/Facility Agreement plus Charge (the bank's security). Completion happens only once both are stamped and the loan is disbursed."
  - "Under the Stamp Act 1949's First Schedule (Item 32(a)), transfer duty on real property is tiered — RM1 per RM100 on the first RM100,000, RM2 per RM100 on the next RM400,000, RM3 per RM100 on the next RM500,000, and RM4 per RM100 above RM1,000,000 — calculated on whichever is higher, the price or LHDN's market valuation."
  - "The buyer, not the seller, is legally liable to pay transfer stamp duty, per the Third Schedule of the Stamp Act 1949."
  - "A new-project purchase from a licensed developer follows a statutory Schedule G/H Sale and Purchase Agreement under the Housing Development (Control and Licensing) Act 1966 — with fixed instalment percentages, a mandated vacant-possession deadline, and automatic liquidated damages for late delivery. A sub-sale (resale) SPA has none of that — its timelines and forfeiture terms are privately negotiated."
  - "From 1 January 2026, non-citizens who are not permanent residents pay a flat 8% transfer duty on residential property (up from a general 4% non-citizen rate that still applies to non-residential property); Malaysian citizens and PRs stay on the 1–4% tiered scale."
  - "Malaysia is moving stamp duty to a self-assessment system (STSDS) via MyTax: leases and general stamping from 1 January 2026, property transfers not requiring a JPPH valuation from 1 January 2027, and everything else from 1 January 2028."
appliesTo: "Malaysian citizens, permanent residents, first-time home buyers, and foreign buyers (subject to additional restrictions and duty rates)"
...
Two lawyers usually touch a Malaysian home purchase, and most buyers never notice they're two different people. One drafts and stamps the Sale and Purchase Agreement that moves the property. The other — appointed by the bank, sometimes the same firm — drafts and stamps the loan and the charge that lets the bank seize the property if the loan isn't repaid. Buyers who think of "the lawyer" as a single character in this story tend to be the ones confused later about why two sets of legal fees showed up, or why the keys didn't arrive the day the loan was approved.
