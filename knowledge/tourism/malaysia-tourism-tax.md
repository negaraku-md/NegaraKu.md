...
category: "tourism"
subcategory: ["tax"]
summary: "Malaysia charges foreign guests a flat RM10 tourism tax per room per night, collected by hotels and online booking platforms and remitted to Customs through the MyTTx portal."
...
appliesTo: "Foreign travellers to Malaysia, hotel and short-stay accommodation operators, and online travel platforms."

faq:
  - q: "How much is Malaysia's tourism tax?"
    a: "A flat RM10.00 per room per night, set by the Tourism Tax (Rate of Tax) Order 2017. It does not scale with the room rate or the number of people in the room."
  - q: "Do Malaysians and permanent residents pay it?"
    a: "No. Under the Tourism Tax (Exemption) Order 2017, Malaysian citizens (MyKad holders) and permanent residents (MyPR holders) are exempt from the whole of the tax."
  - q: "Is it per person or per room?"
    a: "Per room, per night. If two foreign guests share one room, the tax is RM10 for that room, not RM20. Whoever the room is invoiced to pays it."
  - q: "Who collects the tax when I book through Agoda or Booking.com?"
    a: "The online platform (a Digital Platform Service Provider, or DPSP) must charge TTx at the time of booking. During the grace period to 31 December 2025, if you pay the hotel directly rather than the platform, the hotel collects it instead so you are not charged twice."
  - q: "Are small guesthouses and homestays taxed?"
    a: "Operators with four accommodation rooms or fewer are exempt, as are homestays and kampungstays registered with the Ministry of Tourism under its official programmes."
  - q: "How do hotels pay the tax to the government?"
    a: "They register on the MyTTx portal, file a quarterly return (Form TTx-03) and remit the tax to the Royal Malaysian Customs Department no later than the last day of the month after each taxable period."
...
1. **Register** within 30 days of starting operations, using Form TTx-01. Customs issues a Tourism Tax Identification Number and a certificate that must be displayed at each premise.
2. **Collect** RM10 per room per night from foreign guests, normally at check-out, and issue an invoice showing the tax separately.
3. **File and pay** a return (Form TTx-03) for each taxable period — a three-month quarterly period by default, or the operator's existing GST period where applicable — no later than the last day of the month after that period ends. A nil return is still required even when no tax was collected.
