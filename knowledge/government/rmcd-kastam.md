...
summary: "Agency entity page for Jabatan Kastam Diraja Malaysia — what it administers, how its remit splits from LHDN's, the statutes behind each duty and levy, and the portals where the rules actually live."
...
Two agencies, one ministry, and a line that almost nobody draws correctly on the
