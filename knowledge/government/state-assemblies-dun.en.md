---
topicId: MY-GOV-0052
title: "Dewan Undangan Negeri: How a State Makes Its Own Laws"
slug: "state-assemblies-dun"
category: "government"
subcategory: ["institutions"]
summary: "A descriptive account of the State Legislative Assembly (Dewan Undangan Negeri, DUN) as set out by the Federal Constitution — the composition of the Ruler and one House under section 3 of the Eighth Schedule, elected members under section 4, a five-year term under section 9, the passage of a state Bill under section 11, and the 'essential provisions' guarantee of Article 71."
...
appliesTo: "Anyone who needs to understand descriptively how a State Legislative Assembly is formed under the Constitution, how long it lasts, and how a state Bill passes through it to become law."
...
1. **Section 11(1)** — the Legislature's power to make law is exercised through a **Bill passed by the DUN and assented to by the Ruler**.
2. **Section 11(2)** — a Bill or amendment involving expenditure from the State Consolidated Fund may only be brought in by **a member of the State Executive Council**.
3. **Section 11(2A)** — the Ruler shall assent to the Bill within **30 days** after it is presented to him.
4. **Section 11(2B)** — if it is not assented to within that period, the Bill **becomes law once that 30-day period expires**, as if it had been assented to.
5. **Section 11(3)** — a Bill becomes law once assented to, but **no law comes into force until it is published**.
...
- **Confusing the DUN with the Dewan Negara.** The DUN is the legislature of a state; [Dewan Negara](/en/government/dewan-rakyat) is the upper House of the federal Parliament. The name "Dewan Negeri" used by some states (for example Dewan Negeri Johor) refers to that state's DUN, not the Dewan Negara.
...
- [Dewan Rakyat](/en/government/dewan-rakyat) — compare the DUN's structure with the lower House of the federal Parliament, including the difference in how the number of seats is fixed.
- [Who Makes What Law: The Federal, State and Concurrent Lists](/en/government/federal-state-division) — the subjects a DUN can and cannot legislate on.
- [Election Commission (SPR)](/en/government/spr-election-commission) — the body that conducts DUN elections and constituency delimitation.
- [Conference of Rulers](/en/government/majlis-raja-raja) — the role of the Malay Rulers in Malaysia's constitutional system.
- [Federal Constitution](/en/law/federal-constitution) — the parent document containing Article 71 and the Eighth Schedule.
