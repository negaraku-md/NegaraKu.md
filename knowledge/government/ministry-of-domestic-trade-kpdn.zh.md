---
topicId: "MY-GOV-0094"
title: "国内贸易及生活成本部（KPDN）"
seoTitle: "KPDN：国内贸易及生活成本部"
socialTitle: "被商家坑了？这个部门的职责就是替你讨回公道"
slug: "ministry-of-domestic-trade-kpdn"
category: "government"
subcategory: ["ministries"]
summary: "KPDN 是马来西亚负责国内贸易、消费者保护及生活成本管控的联邦部门，负责执行价格与反暴利法令，并监管 SSM、MyIPO、MyCC 等机构。"
tier: "3"
mode: "practical"
contentType: "agency"
sensitivity: "none"
answer: "国内贸易及生活成本部（Kementerian Perdagangan Dalam Negeri dan Kos Sara Hidup，KPDN）是马来西亚负责发展国内贸易、管控必需品价格及保护消费者的联邦部门。该部于 1990 年 10 月 27 日成立，执行诸如《2011 年价格管制及反暴利法令》和《1961 年供应管制法令》等法令，监管 SSM、MyIPO 及 MyCC 等机构，并设有普通消费者在遭商家欺骗时可使用的投诉管道及理赔上限为 RM50,000 的消费者仲裁庭。"
keyTakeaways:
  - "KPDN 于 1990 年 10 月 27 日成立，并在 2022 年 12 月采用现有的「生活成本」名称；总部位于布城第 2 区（Precinct 2, Putrajaya）。"
  - "该部依据《1961 年供应管制法令》和《2011 年价格管制及反暴利法令》，透过 Ops Pantau 及节庆最高价格计划等行动，稳定稻米、鸡蛋、食油和鸡肉等必需品的价格。"
  - "消费者可透过客服热线 1-800-886-800、WhatsApp 019-848 8000、e-Aduan 门户网站、电邮 e-aduan@kpdn.gov.my，或 Ez ADU 应用程序进行投诉。"
  - "消费者索偿仲裁庭（TTPM）于 1999 年 11 月 15 日依据《1999 年消费者保护法令》设立，受理不超过 RM50,000 的索偿。"
  - "KPDN 属下机构包括 SSM、MyIPO、MyCC、SKM、MKM、PNS 及 Bank Rakyat；现任部长为 Datuk Armizan Mohd Ali。"
appliesTo: "被多收费或遭欺骗的消费者、受价格管制约束的商家和零售商，以及在马来西亚处理公司注册、竞争或消费者保护事务的任何人。"
faq:
  - q: "如果商家欺骗我，该如何向 KPDN 投诉？"
    a: "您可透过客服热线 1-800-886-800、WhatsApp 019-848 8000、e-Aduan 门户网站 eaduan.kpdn.gov.my、电邮 e-aduan@kpdn.gov.my，或 Ez ADU KPDN 智能手机应用程序提出投诉。"
  - q: "我在消费者索偿仲裁庭最多可索偿多少？"
    a: "消费者索偿仲裁庭（TTPM）于 1999 年 11 月 15 日依据《1999 年消费者保护法令》第 85 条设立，受理不超过 RM50,000 的消费者索偿。"
  - q: "KPDN 依据哪些法令管控价格？"
    a: "该部主要依据《1961 年供应管制法令》和《2011 年价格管制及反暴利法令》，据此设定价格上限、要求标示价格，并对不合理的高额利润采取行动。"
lang: "zh"
masterLanguage: "en"
...
当商家在食油上向你多收费、以高于顶价的价格出售受管制商品，或拒绝为有缺陷的产品负责时，负责代你采取行动的联邦机构就是 **KPDN**——**国内贸易及生活成本部**（*Kementerian Perdagangan Dalam Negeri dan Kos Sara Hidup*）。它发展国内贸易、管控日常必需品的价格、保护消费者，并以实实在在的法令、可用的投诉管道，以及一个为普通消费者而设的小额索偿仲裁庭作为后盾。

## KPDN 是什么，其职能为何？

KPDN 于 **1990 年 10 月 27 日成立**。其既定目标是促进「可行、具竞争力且可持续」的国内贸易，尤其是在分销贸易领域，同时保护消费者的利益与权益。在实务上，其工作分为两大部分：制定贸易政策——包括确定和监控必需品价格，以及管控必需品、石油和石化产品的销售与分销——以及消费主义，涵盖消费者教育、意识提升、保护，以及对消费者运动的支持。

该部于 **2022 年 12 月**采用现有名称，加入了「生活成本」的重点。其总部位于 No. 13, Persiaran Perdana, Precinct 2, Federal Government Administrative Centre, 62623 Putrajaya。现任部长为 **Datuk Armizan Mohd Ali**，自 2023 年 7 月 30 日起领导该部。

## KPDN 依据哪些法令来控制价格？

KPDN 及其属下机构负责执行一系列贸易与消费者法令。普通马来西亚人最有可能切身感受到的法令如下：
...
你不需要请律师就能开始。KPDN 透过多个管道受理消费者投诉：

- **客服热线：** 1-800-886-800
- **WhatsApp：** 019-848 8000
- **e-Aduan 门户网站：** eaduan.kpdn.gov.my
- **电邮：** e-aduan@kpdn.gov.my
- **应用程序：** Ez ADU KPDN 智能手机应用程序

对于涉及金钱的纠纷——有缺陷的产品、未交付的服务、不公平的收费——则有**消费者索偿仲裁庭（TTPM）**。它于 **1999 年 11 月 15 日**依据《1999 年消费者保护法令》第十二部分第 85 条设立，以远低于法庭的费用和程序繁琐度，受理**不超过 RM50,000** 的索偿。

## KPDN 属下有哪些机构？

该部的大部分日常监管工作由其属下的法定机构执行：

- **SSM** — 马来西亚公司委员会（公司及商业注册）
- **MyIPO** — 马来西亚知识产权局（专利、商标、版权）
- **MyCC** — 马来西亚竞争委员会
- **SKM** — 马来西亚合作社委员会
- **MKM** — 马来西亚合作社学院
...
如果你被多收费或受误导，请收集你的收据和证据，并透过上述管道之一提出投诉；对于金额不超过 RM50,000 的金钱纠纷，请准备向 TTPM 提交申请。至于公司或商标事务，则直接前往相关机构——公司事务找 **SSM**，知识产权事务找 **MyIPO**。
