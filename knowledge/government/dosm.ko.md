...
keyTakeaways:
  - "통계법(Statistics Act 1965, Act 415)에 따라 운영된다 — 국왕 재가 1965년 6월 22일, 발효 1965년 8월 16일, 개정판 1989년"
  - "경제부(Ministry of Economy) 산하의 연방 부서로, 말레이시아 통계청장(Chief Statistician Malaysia, Ketua Perangkawan Malaysia)이 이끈다"
  - "1949년 통계 조례(Statistics Ordinance 1949)에 따른 통계국(Bureau of Statistics)으로 출범하였으며, 1965년에 개칭되었다"
  - "2026년 모든 발표의 정확한 날짜를 명시한 사전 공개 일정표(Advance Release Calendar)를 발행하며, CSV, Parquet, iCalendar 또는 구독 가능한 구글 캘린더로 내려받을 수 있다"
  - "주요 통계 시리즈: GDP(분기), 소비자물가지수(CPI), 노동력, 대외 무역, 산업생산지수(IPI), 생산자물가지수(PPI), 그리고 말레이시아 경제지표(월간)"
  - "GDP 속보치(advance estimate)는 분기 GDP 전체 발표보다 대략 4주 앞서 나온다"
  - "OpenDOSM 데이터는 CC BY 4.0으로 공개되며 data.gov.my API를 통해 접근할 수 있다"
  - "2026년 5월 1일부터 디지털 배포가 DOSM의 주된 발표 경로가 되었다"
appliesTo: "말레이시아의 경제·사회 통계를 원자료에서 확인하거나, 다음 공식 수치가 언제 발표될지를 미리 알아야 하는 모든 사람."

faq:
  - q: "다음 CPI 또는 GDP 수치가 언제 발표되는지 어떻게 알 수 있습니까?"
    a: "dosm.gov.my/portal-main/arc의 DOSM 사전 공개 일정표(Advance Release Calendar)를 이용하십시오. 동일한 데이터가 OpenDOSM과 data.gov.my에 기계가 읽을 수 있는 데이터셋(arc_dosm)으로 발행되며, 그해 모든 발표의 공개일, 영어·말레이어 제목, 범주와 빈도가 담겨 있습니다. 구글 캘린더로 구독하거나 .ics 파일로 내려받을 수 있습니다."
  - q: "GDP 속보치와 실제 GDP 발표의 차이는 무엇입니까?"
    a: "속보치는 분기 국민계정 전체 발표보다 약 4주 앞서 발행되는 예비 수치입니다. 2026년 2분기의 경우 DOSM은 2026년 7월 17일에 속보치를 발행하고 실제 GDP 발표를 2026년 8월 14일로 예정하였습니다. 정확성이 중요한 경우에는 전체 발표를 인용하십시오."
  - q: "DOSM 데이터는 자유롭게 재사용할 수 있습니까?"
    a: "OpenDOSM을 통해 발행되는 데이터셋은 크리에이티브 커먼즈 저작자표시 4.0 국제(CC BY 4.0) 라이선스를 따르므로, 출처를 표시하면 재사용할 수 있습니다. data.gov.my의 일부 데이터셋은 다른 기관에서 비롯되므로, 개별 데이터셋 페이지의 라이선스 표기를 확인하십시오."
  - q: "DOSM은 어느 부처 산하에 있습니까?"
    a: "DOSM은 해당 부처의 공식 기관 목록에서 경제부(Ministry of Economy) 산하에 등재된 연방정부 부서입니다. 말레이시아의 부처 소관은 주기적으로 재편되므로, 공식 문서에서 의존하기 전에 ekonomi.gov.my 또는 dosm.gov.my에서 현재 편제를 확인하십시오."
