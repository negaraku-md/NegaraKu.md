...
summary: "Unmodified, qualified, adverse and disclaimer — decided by the two-axis test in ISA 705 (Revised) as adopted in Malaysia: the nature of the matter, and the auditor's judgement about pervasiveness."
...
appliesTo: "Directors, lenders, buyers and finance staff who need to understand why a Malaysian audit report says what it says."

faq:
  - q: "What is the difference between a qualified and an adverse opinion?"
    a: "Both arise from a material misstatement. Paragraph 7(a) of ISA 705 (Revised) requires a qualified opinion where the misstatements are material but not pervasive, and paragraph 8 requires an adverse opinion where they are both material and pervasive. A qualified opinion says the statements are fair except for one identified matter. An adverse opinion says they do not give a true and fair view at all."
  - q: "What does pervasive actually mean?"
    a: "Paragraph 5(a) of ISA 705 (Revised) defines it. Effects are pervasive if they are not confined to specific elements, accounts or items of the financial statements; or if so confined, represent or could represent a substantial proportion of the financial statements; or, for disclosures, are fundamental to users understanding of the financial statements."
  - q: "Is a disclaimer of opinion worse than an adverse opinion?"
    a: "They are different failures. An adverse opinion is a definite statement that the financial statements are materially misstated. A disclaimer says the auditor could not obtain enough evidence to form any opinion at all. Lenders often treat a disclaimer as worse because it leaves the position unknown rather than known and wrong."
  - q: "Can we just change auditors to avoid a modified opinion?"
    a: "No, and it makes things worse. Under R320.4 MY of the MIA By-Laws the incoming firm must ask the outgoing firm whether there is a professional reason for the change, and the outgoing auditor separately lodges any statement of circumstances with the Registrar. The next firm inherits the same evidence problem and now knows why you moved."
  - q: "Does a modified opinion stop us lodging with SSM?"
    a: "No. The financial statements are still circulated to members within six months of the financial year end under s.258 and lodged within 30 days of circulation under s.259, modified opinion or not. The commercial consequences come from lenders, tender panels and buyers, not from the Registrar."
  - q: "Where can I see the Malaysian wording for each opinion?"
...
Every competing page lists four opinions and defines each in a sentence. None of
