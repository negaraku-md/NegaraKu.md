...
category: "audit"
subcategory: ["foreign"]
summary: "A foreign company registered in Malaysia must lodge audited financial statements with SSM every year — both the whole company's accounts and a separate audited statement of its Malaysian branch operations — under sections 574 and 575 of the Companies Act 2016."
...
appliesTo: "Foreign companies registered under Part V Division 1 of the Companies Act 2016 operating a branch or place of business in Malaysia, and their local agents."

faq:
  - q: "Which section of the Companies Act 2016 requires a foreign branch to file audited accounts?"
    a: "Section 575 requires a registered foreign company to lodge its financial statements and a duly audited statement of its Malaysian operations with the Registrar. Section 574 requires it to keep auditable accounting records in Malaysia."
  - q: "When must a foreign company lodge its financial statements?"
    a: "Within two months of its annual general meeting, per section 575(1). If the home jurisdiction does not require an AGM or financial statements, it must prepare and lodge accounts as a public company incorporated in Malaysia would (section 575(4))."
  - q: "Does the parent company's audit satisfy the requirement?"
    a: "A copy of the company's own financial statements must be lodged, but section 575(5) additionally requires a duly audited statement covering assets used in and liabilities arising out of its Malaysian operations, giving a true and fair view under approved accounting standards."
