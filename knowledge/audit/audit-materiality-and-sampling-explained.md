...
summary: "How auditors set a materiality threshold and choose which transactions to test, under the ISA 320, ISA 450 and ISA 530 standards that Malaysia adopts unchanged."
...
answer: "Auditors do not check every transaction. They set a materiality threshold (ISA 320) that marks the size of error that could change a reader's decision, then test a sample of items (ISA 530) large enough to give reasonable assurance that undetected error stays below that threshold. Errors the sample turns up are accumulated and weighed against materiality (ISA 450). Malaysia applies all three standards as issued by the IAASB, without modification."
keyTakeaways:
...
appliesTo: "Directors, finance staff, students and business owners who want to understand why an auditor tested some transactions and not others."

faq:
  - q: "Does the auditor look at every transaction?"
    a: "No. Audit sampling applies procedures to less than 100% of a population so that all items have a chance of selection, giving a reasonable basis to conclude on the whole population (ISA 530, para 5(a))."
  - q: "What is the difference between materiality and performance materiality?"
    a: "Materiality is the threshold for the financial statements as a whole. Performance materiality is set lower, to reduce the chance that many small uncorrected and undetected errors add up past that threshold (ISA 320, para 9)."
  - q: "Do these standards apply in Malaysia?"
    a: "Yes. The Malaysian Institute of Accountants adopts the IAASB's pronouncements as the Malaysian Approved Standards on Auditing without modification, so ISA 320, 450 and 530 apply to Malaysian statutory audits."
