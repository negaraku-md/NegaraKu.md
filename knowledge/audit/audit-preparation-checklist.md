...
category: "audit"
subcategory: ["process"]
summary: "A prepared-by-client checklist for a Malaysian statutory audit, organised by cycle, with the assertion each item is there to support and the three items that reliably blow the deadline."
...
appliesTo: "Finance managers, accountants and company secretaries preparing a Malaysian Sdn Bhd for its statutory audit."

faq:
  - q: "What does PBC mean?"
    a: "Prepared by client. It is the list of schedules, reconciliations and supporting documents the audit team needs before and during fieldwork. A good list arrives at planning, is organised by cycle, and states the year end date for every schedule so that what you produce ties to the trial balance."
  - q: "Why does the auditor want supplier statements when I already gave them the ledger?"
    a: "Because the ledger cannot prove completeness. A liability that was never recorded does not appear in your own records. The supplier statement is third-party evidence, and the search for unrecorded liabilities using post-year-end payments does the same job from another direction."
  - q: "Do I have to give the auditor access to the minute book and registers?"
    a: "Yes. Section 266(4) of the Companies Act 2016 gives the auditor a right of access at all reasonable times to the accounting and other records including registers. Section 266(12) makes obstructing or delaying an auditor an offence punishable by up to three years imprisonment or a fine up to RM500,000."
  - q: "What is a related party under MFRS 124?"
    a: "It reaches further than most finance teams expect — the parent, subsidiaries and fellow subsidiaries, associates and joint ventures, key management personnel and their close family members, and entities controlled or jointly controlled by any of those people. A company owned by a director's spouse that buys from you is a related party, and the transaction is disclosable even at arm's length."
  - q: "How far in advance should I start preparing?"
    a: "Reconciliations and schedules should be complete within three to four weeks of the year end. Anything requiring a third party — bank confirmations, solicitors letters, intercompany agreement with a fellow subsidiary in another country — should be initiated in week one, because those are measured in weeks and are outside your control."
  - q: "Can I give the auditor management accounts instead of a trial balance?"
    a: "No. Fieldwork is performed against a locked trial balance. If the trial balance keeps moving, every schedule already tested has to be re-agreed, and that is the fastest way to convert a two-week fieldwork into a six-week one."
...
The request list looks like an administrative document. It is not. It is the audit
