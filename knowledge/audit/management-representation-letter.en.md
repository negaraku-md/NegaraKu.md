---
topicId: MY-AUD-0024
title: "Management Representation Letter: What It Is and Why Auditors Need It"
seoTitle: "Management Representation Letter (ISA 580): A Quick Guide"
slug: "management-representation-letter"
category: "audit"
subcategory: ["assurance"]
summary: "A management representation letter is a written acknowledgement signed by directors and requested by the auditor under ISA 580 as audit evidence. It confirms that management takes responsibility for the financial statements and has provided all relevant information."
...
answer: "A management representation letter is a letter addressed to the auditor that confirms certain matters and supports other audit evidence. Under ISA 580, the auditor is required to request it from management that has the appropriate responsibilities and knowledge — typically the CEO and CFO. The signature confirms that management takes responsibility for preparing the financial statements and has provided all relevant information. If the required representations are not provided, the auditor shall disclaim the opinion."
keyTakeaways:
  - "ISA 580 defines written representations as a written statement by management to the auditor; it does not include the financial statements themselves."
  - "The letter is requested from management with the appropriate responsibilities and knowledge, typically the chief executive officer and chief financial officer (paragraphs 9, A2)."
  - "The letter should be dated as near as practicable to, but not after, the date of the auditor's report (paragraph 14)."
  - "If management fails to provide the representations required by paragraphs 10 and 11, the auditor shall disclaim the opinion in accordance with ISA 705 (paragraph 20)."
appliesTo: "Directors and management of companies being audited, auditors, company secretaries, and accounting students in Malaysia."

faq:
  - q: "Who needs to sign the management representation letter?"
    a: "Representations are requested from management that has responsibility for the financial statements and knowledge of the matters concerned. According to paragraph A2 of ISA 580, this is typically the chief executive officer (CEO) and chief financial officer (CFO) of the company, or equivalent individuals."
  - q: "Does this letter replace the rest of the audit work?"
    a: "No. Paragraph 4 of ISA 580 stresses that written representations do not provide sufficient appropriate audit evidence on their own. They complement, but do not replace, other audit procedures."
  - q: "What happens if management refuses to sign?"
    a: "If management does not provide the representations required by paragraphs 10 and 11, the auditor shall disclaim the opinion on the financial statements in accordance with ISA 705 (paragraph 20)."
...
revision: 0
verificationNeeded:
  - "Confirm that the version of ISA 580 referenced (IAASB Handbook 2012) still matches the latest ISA 580 in force in Malaysia, including the numbering of paragraphs 4, 7, 9, 10, 11, 13, 14, 15, 17, 20, A2, A5, A6."
...
Towards the end of every audit, directors are asked to sign a document that is easy to overlook but carries real weight: a letter attesting, with their own signature, that they have told the auditor everything. That is the management representation letter.
