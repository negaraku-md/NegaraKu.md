...
export type Locale = ContentLocale | 'ta' | 'ja' | 'ko';
 ...
 */
export type Localized = Record<ContentLocale, string> & Partial<Record<'ta' | 'ja' | 'ko', string>>;
...
export const ARCHETYPES: ArchetypeDef[] = [
  {
    id: 'service',
    icon: '🧭',
    name: { ms: 'Perkhidmatan / Prosedur', en: 'Service / Procedural', zh: '服务 / 流程', ta: 'சேவை / நடைமுறை', ja: 'サービス・手続き', ko: '서비스·절차' },
    pattern: {
  ...
  },
  {
    id: 'narrative',
    icon: '📜',
    name: { ms: 'Naratif / Garis Masa', en: 'Narrative / Timeline', zh: '叙事 / 时间线', ta: 'கதையாடல் / காலவரிசை', ja: '物語・年表', ko: '서사·연표' },
    pattern: {
  ...
  },
  {
    id: 'place',
    icon: '📍',
    name: { ms: 'Tempat / Entiti', en: 'Place / Entity', zh: '地方 / 实体', ta: 'இடம் / அமைப்பு', ja: '場所・組織', ko: '장소·기관' },
    pattern: {
  ...
  },
  {
    id: 'reference',
    icon: '🏛',
    name: { ms: 'Rujukan / Direktori', en: 'Reference / Directory', zh: '参考 / 名录', ta: 'மேற்கோள் / அடைவு', ja: 'リファレンス・名簿', ko: '참고·명부' },
    pattern: {
  ...
  },
  {
    id: 'lookup',
    icon: '📖',
    name: { ms: 'Carian Istilah', en: 'Lookup', zh: '术语查询', ta: 'சொல் தேடல்', ja: '用語検索', ko: '용어 검색' },
    pattern: {
  ...
  },
  {
    id: 'data',
    icon: '📊',
    name: { ms: 'Data / Petunjuk', en: 'Data / Indicators', zh: '数据 / 指标', ta: 'தரவு / குறிகாட்டிகள்', ja: 'データ・指標', ko: '데이터·지표' },
    pattern: {
...
export const PILLARS: PillarDef[] = [
  {
    id: 'understand',
    icon: '📖',
    name: { ms: 'Kenali Malaysia', en: 'Understand Malaysia', zh: '认识马来西亚', ta: 'மலேசியாவை அறிக', ja: 'マレーシアを知る', ko: '말레이시아 이해하기' },
    tagline: {
  ...
  },
  {
    id: 'living',
    icon: '🏠',
    name: { ms: 'Hidup di Malaysia', en: 'Living in Malaysia', zh: '在马来西亚生活', ta: 'மலேசியாவில் வாழ்க்கை', ja: 'マレーシアで暮らす', ko: '말레이시아에서 생활하기' },
    tagline: {
  ...
  },
  {
    id: 'doing-business',
    icon: '💼',
    name: { ms: 'Berniaga di Malaysia', en: 'Doing Business in Malaysia', zh: '在马来西亚经商', ta: 'மலேசியாவில் வணிகம்', ja: 'マレーシアでビジネス', ko: '말레이시아에서 사업하기' },
    tagline: {
...
export const CATEGORIES: Category[] = [
  // ---------------- Understand ----------------
  {
    ...
    icon: '🌺',
    name: { ms: 'Malaysia', en: 'Malaysia', zh: '马来西亚', ta: 'மலேசியா', ja: 'マレーシア', ko: '말레이시아' },
    blurb: {
  ...
  },
  {
    id: 'states',
    icon: '📍',
    name: { ms: 'Negeri & Wilayah', en: 'States & Territories', zh: '州与联邦直辖区', ta: 'மாநிலங்கள் & பிரதேசங்கள்', ja: '州・連邦直轄領', ko: '주 및 연방 직할구' },
    blurb: {
  ...
  },
  {
    id: 'government',
    icon: '🏛',
    name: { ms: 'Kerajaan', en: 'Government', zh: '政府', ta: 'அரசாங்கம்', ja: '政府', ko: '정부' },
    blurb: {
  ...
  },
  {
    id: 'law',
    icon: '⚖',
    name: { ms: 'Undang-Undang', en: 'Law & Regulations', zh: '法律与法规', ta: 'சட்டம் & விதிமுறைகள்', ja: '法律・規制', ko: '법률 및 규정' },
    blurb: {
  ...
  },
  {
    id: 'economy',
    icon: '📈',
    name: { ms: 'Ekonomi', en: 'Economy', zh: '经济', ta: 'பொருளாதாரம்', ja: '経済', ko: '경제' },
    blurb: {
  ...
  },
  {
    id: 'arts-culture',
    icon: '🎭',
    name: { ms: 'Seni & Budaya', en: 'Arts & Culture', zh: '艺术与文化', ta: 'கலை & பண்பாடு', ja: '芸術・文化', ko: '예술 및 문화' },
    blurb: {
  ...
  },
  {
    id: 'glossary',
    icon: '📖',
    name: { ms: 'Glosari', en: 'Glossary', zh: '术语库', ta: 'சொற்களஞ்சியம்', ja: '用語集', ko: '용어집' },
    blurb: {
  ...
  },
  {
    id: 'international',
    icon: '🌏',
    name: { ms: 'Antarabangsa', en: 'International', zh: '国际', ta: 'சர்வதேசம்', ja: '国際', ko: '국제' },
    blurb: {
  ...
  // ---------------- Business ----------------
  {
    id: 'business',
    icon: '💼',
    name: { ms: 'Perniagaan', en: 'Business', zh: '商业', ta: 'வணிகம்', ja: 'ビジネス', ko: '비즈니스' },
    blurb: {
  ...
  },
  {
    id: 'taxation',
    icon: '🧾',
    name: { ms: 'Percukaian', en: 'Taxation', zh: '税务', ta: 'வரிவிதிப்பு', ja: '税務', ko: '세무' },
    blurb: {
  ...
  },
  {
    ...
    icon: '📑',
    name: { ms: 'Setiausaha Syarikat', en: 'Company Secretary', zh: '公司秘书', ta: 'நிறுவனச் செயலாளர்', ja: '会社秘書役', ko: '회사 비서' },
    blurb: {
  ...
  },
  {
    id: 'accounting',
    icon: '📊',
    name: { ms: 'Perakaunan', en: 'Accounting', zh: '会计', ta: 'கணக்கியல்', ja: '会計', ko: '회계' },
    blurb: {
  ...
  },
  {
    id: 'audit',
    icon: '🔍',
    name: { ms: 'Audit & Jaminan', en: 'Audit & Assurance', zh: '审计与鉴证', ta: 'தணிக்கை & உறுதிப்படுத்தல்', ja: '監査・保証', ko: '감사 및 인증' },
    blurb: {
  ...
  },
  {
    id: 'employment',
    icon: '👥',
    name: { ms: 'Pekerjaan & HR', en: 'Employment & HR', zh: '就业与人力资源', ta: 'வேலைவாய்ப்பு & மனிதவளம்', ja: '雇用・人事', ko: '고용 및 인사' },
    blurb: {
  ...
  },
  {
    id: 'finance',
    icon: '💰',
    name: { ms: 'Kewangan & Perbankan', en: 'Finance & Banking', zh: '金融与银行', ta: 'நிதி & வங்கியியல்', ja: '金融・銀行', ko: '금융 및 은행' },
    blurb: {
  ...
  },
  {
    id: 'industries',
    icon: '🏭',
    name: { ms: 'Industri', en: 'Industries', zh: '行业', ta: 'தொழில்துறைகள்', ja: '産業', ko: '산업' },
    blurb: {
  ...
  },
  {
    id: 'companies',
    icon: '🏢',
    name: { ms: 'Syarikat', en: 'Companies', zh: '公司', ta: 'நிறுவனங்கள்', ja: '企業', ko: '기업' },
    blurb: {
  ...
  },
  {
    id: 'technology',
    icon: '💻',
    name: { ms: 'Teknologi & AI', en: 'Technology & AI', zh: '科技与人工智能', ta: 'தொழில்நுட்பம் & செயற்கை நுண்ணறிவு', ja: 'テクノロジー・AI', ko: '기술 및 AI' },
    blurb: {
  ...
  // ---------------- Living ----------------
  {
    id: 'education',
    icon: '🎓',
    name: { ms: 'Pendidikan', en: 'Education', zh: '教育', ta: 'கல்வி', ja: '教育', ko: '교육' },
    blurb: {
  ...
  },
  {
    id: 'healthcare',
    icon: '🩺',
    name: { ms: 'Kesihatan', en: 'Healthcare', zh: '医疗保健', ta: 'சுகாதாரம்', ja: '医療', ko: '의료' },
    blurb: {
  ...
  },
  {
    id: 'property',
    icon: '🏠',
    name: { ms: 'Hartanah', en: 'Property', zh: '房地产', ta: 'சொத்து', ja: '不動産', ko: '부동산' },
    blurb: {
  ...
  },
  {
    id: 'transport',
    icon: '🚗',
    name: { ms: 'Pengangkutan', en: 'Transport', zh: '交通', ta: 'போக்குவரத்து', ja: '交通', ko: '교통' },
    blurb: {
  ...
  },
  {
    id: 'tourism',
    icon: '🌍',
    name: { ms: 'Pelancongan', en: 'Tourism', zh: '旅游', ta: 'சுற்றுலா', ja: '観光', ko: '관광' },
    blurb: {
  ...
  },
  {
    id: 'food-lifestyle',
    icon: '🍜',
    name: { ms: 'Makanan & Gaya Hidup', en: 'Food & Lifestyle', zh: '美食与生活', ta: 'உணவு & வாழ்க்கை முறை', ja: '食・ライフスタイル', ko: '음식 및 라이프스타일' },
    blurb: {
  ...
  },
  {
    id: 'public-safety',
    icon: '🛡',
    name: { ms: 'Keselamatan Awam', en: 'Public Safety', zh: '公共安全', ta: 'பொதுப் பாதுகாப்பு', ja: '公共安全', ko: '공공 안전' },
    blurb: {
  ...
  },
  {
    id: 'agriculture',
    icon: '🌱',
    name: { ms: 'Pertanian', en: 'Agriculture', zh: '农业', ta: 'விவசாயம்', ja: '農業', ko: '농업' },
    blurb: {
  ...
  },
  {
    id: 'energy',
    icon: '⚡',
    name: { ms: 'Tenaga & Utiliti', en: 'Energy & Utilities', zh: '能源与公用事业', ta: 'ஆற்றல் & பயன்பாட்டுச் சேவைகள்', ja: 'エネルギー・公益事業', ko: '에너지 및 공익사업' },
    blurb: {
  ...
  },
  {
    id: 'environment',
    icon: '🌳',
    name: { ms: 'Alam Sekitar', en: 'Environment', zh: '环境', ta: 'சுற்றுச்சூழல்', ja: '環境', ko: '환경' },
    blurb: {
  ...
  },
  {
    id: 'sports',
    icon: '⚽',
    name: { ms: 'Sukan', en: 'Sports', zh: '体育', ta: 'விளையாட்டு', ja: 'スポーツ', ko: '스포츠' },
    blurb: {
  ...
  },
  {
    id: 'settling-in',
    icon: '🛬',
    name: { ms: 'Menetap di Malaysia', en: 'Settling In', zh: '落地安顿', ta: 'குடியேறுதல்', ja: '定住手続き', ko: '정착하기' },
    blurb: {
  ...
  },
  {
    id: 'money-daily-life',
    icon: '💳',
    name: { ms: 'Wang & Kehidupan Harian', en: 'Money & Daily Life', zh: '金钱与日常', ta: 'பணம் & அன்றாட வாழ்க்கை', ja: 'お金・日常生活', ko: '돈과 일상생활' },
    blurb: {
  ...
  },
  {
    id: 'cost-of-living',
    icon: '🧾',
    name: { ms: 'Kos Sara Hidup', en: 'Cost of Living', zh: '生活成本', ta: 'வாழ்க்கைச் செலவு', ja: '生活費', ko: '생활비' },
    blurb: {
